...
enum opt_code
{
  ...
  OPT_Wpedantic_param_names = 854,           /* -Wpedantic-param-names */
  OPT_Wpessimizing_move = 855,               /* -Wpessimizing-move */
  /* OPT_Wplacement_new = 856, */            /* -Wplacement-new */
  OPT_Wplacement_new_ = 857,                 /* -Wplacement-new= */
  OPT_Wpmf_conversions = 858,                /* -Wpmf-conversions */
  OPT_Wpointer_arith = 859,                  /* -Wpointer-arith */
  OPT_Wpointer_compare = 860,                /* -Wpointer-compare */
  OPT_Wpointer_sign = 861,                   /* -Wpointer-sign */
  OPT_Wpointer_to_int_cast = 862,            /* -Wpointer-to-int-cast */
  OPT_Wpragma_once_outside_header = 863,     /* -Wpragma-once-outside-header */
  OPT_Wpragmas = 864,                        /* -Wpragmas */
  OPT_Wpreprocessor_error = 865,             /* -Wpreprocessor-error */
  OPT_Wprio_ctor_dtor = 866,                 /* -Wprio-ctor-dtor */
  OPT_Wprocedure_not_found = 867,            /* -Wprocedure-not-found */
  OPT_Wprocedure_pointer = 868,              /* -Wprocedure-pointer */
  OPT_Wproperty_assign_default = 869,        /* -Wproperty-assign-default */
  OPT_Wprotocol = 870,                       /* -Wprotocol */
  OPT_Wpsabi = 871,                          /* -Wpsabi */
  OPT_Wrange_loop_construct = 872,           /* -Wrange-loop-construct */
  OPT_Wreal_q_constant = 873,                /* -Wreal-q-constant */
  OPT_Wrealloc_lhs = 874,                    /* -Wrealloc-lhs */
  OPT_Wrealloc_lhs_all = 875,                /* -Wrealloc-lhs-all */
  OPT_Wrecording_mode = 876,                 /* -Wrecording-mode */
  OPT_Wredundant_decls = 877,                /* -Wredundant-decls */
  OPT_Wredundant_move = 878,                 /* -Wredundant-move */
  OPT_Wredundant_tags = 879,                 /* -Wredundant-tags */
  OPT_Wregister = 880,                       /* -Wregister */
  OPT_Wreorder = 881,                        /* -Wreorder */
  OPT_Wreplace_error = 882,                  /* -Wreplace-error */
  OPT_Wrestrict = 883,                       /* -Wrestrict */
  OPT_Wreturn_local_addr = 884,              /* -Wreturn-local-addr */
  OPT_Wreturn_mismatch = 885,                /* -Wreturn-mismatch */
  OPT_Wreturn_type = 886,                    /* -Wreturn-type */
  OPT_Wreturning_number = 887,               /* -Wreturning-number */
  OPT_Wscalar_storage_order = 888,           /* -Wscalar-storage-order */
  OPT_Wscope = 889,                          /* -Wscope */
  OPT_Wsegment = 890,                        /* -Wsegment */
  OPT_Wsegment_error = 891,                  /* -Wsegment-error */
  OPT_Wsegment_negative = 892,               /* -Wsegment-negative */
  OPT_Wselector = 893,                       /* -Wselector */
  OPT_Wself_move = 894,                      /* -Wself-move */
  OPT_Wsequence_point = 895,                 /* -Wsequence-point */
  OPT_Wset_locale_to = 896,                  /* -Wset-locale-to */
  OPT_Wset_to_locale = 897,                  /* -Wset-to-locale */
  /* OPT_Wsfinae_incomplete = 898, */        /* -Wsfinae-incomplete */
  OPT_Wsfinae_incomplete_ = 899,             /* -Wsfinae-incomplete= */
  OPT_Wshadow = 900,                         /* -Wshadow */
  /* OPT_Wshadow_compatible_local = 901, */  /* -Wshadow-compatible-local */
  OPT_Wshadow_ivar = 902,                    /* -Wshadow-ivar */
  /* OPT_Wshadow_local = 903, */             /* -Wshadow-local */
  OPT_Wshadow_compatible_local = 904,        /* -Wshadow=compatible-local */
  /* OPT_Wshadow_global = 905, */            /* -Wshadow=global */
  OPT_Wshadow_local = 906,                   /* -Wshadow=local */
  OPT_Wshift_count_negative = 907,           /* -Wshift-count-negative */
  OPT_Wshift_count_overflow = 908,           /* -Wshift-count-overflow */
  OPT_Wshift_negative_value = 909,           /* -Wshift-negative-value */
  /* OPT_Wshift_overflow = 910, */           /* -Wshift-overflow */
  OPT_Wshift_overflow_ = 911,                /* -Wshift-overflow= */
  OPT_Wsign_compare = 912,                   /* -Wsign-compare */
  OPT_Wsign_conversion = 913,                /* -Wsign-conversion */
  OPT_Wsign_promo = 914,                     /* -Wsign-promo */
  OPT_Wsized_deallocation = 915,             /* -Wsized-deallocation */
  OPT_Wsizeof_array_argument = 916,          /* -Wsizeof-array-argument */
  OPT_Wsizeof_array_div = 917,               /* -Wsizeof-array-div */
  OPT_Wsizeof_pointer_div = 918,             /* -Wsizeof-pointer-div */
  OPT_Wsizeof_pointer_memaccess = 919,       /* -Wsizeof-pointer-memaccess */
  OPT_Wspeculative = 920,                    /* -Wspeculative */
  OPT_Wstack_protector = 921,                /* -Wstack-protector */
  OPT_Wstack_usage_ = 922,                   /* -Wstack-usage= */
  OPT_Wstop_number = 923,                    /* -Wstop-number */
  OPT_Wstray_indicator = 924,                /* -Wstray-indicator */
  OPT_Wstrict_aliasing = 925,                /* -Wstrict-aliasing */
  OPT_Wstrict_aliasing_ = 926,               /* -Wstrict-aliasing= */
  OPT_Wstrict_flex_arrays = 927,             /* -Wstrict-flex-arrays */
  OPT_Wstrict_null_sentinel = 928,           /* -Wstrict-null-sentinel */
  OPT_Wstrict_overflow = 929,                /* -Wstrict-overflow */
  OPT_Wstrict_overflow_ = 930,               /* -Wstrict-overflow= */
  OPT_Wstrict_prototypes = 931,              /* -Wstrict-prototypes */
  OPT_Wstrict_selector_match = 932,          /* -Wstrict-selector-match */
  OPT_Wstring_compare = 933,                 /* -Wstring-compare */
  /* OPT_Wstringop_overflow = 934, */        /* -Wstringop-overflow */
  OPT_Wstringop_overflow_ = 935,             /* -Wstringop-overflow= */
  OPT_Wstringop_overread = 936,              /* -Wstringop-overread */
  OPT_Wstringop_truncation = 937,            /* -Wstringop-truncation */
  OPT_Wstyle = 938,                          /* -Wstyle */
  OPT_Wsubobject_linkage = 939,              /* -Wsubobject-linkage */
  OPT_Wsuggest_attribute_cold = 940,         /* -Wsuggest-attribute=cold */
  OPT_Wsuggest_attribute_const = 941,        /* -Wsuggest-attribute=const */
  OPT_Wsuggest_attribute_format = 942,       /* -Wsuggest-attribute=format */
  OPT_Wsuggest_attribute_malloc = 943,       /* -Wsuggest-attribute=malloc */
  OPT_Wsuggest_attribute_noreturn = 944,     /* -Wsuggest-attribute=noreturn */
  OPT_Wsuggest_attribute_pure = 945,         /* -Wsuggest-attribute=pure */
  OPT_Wsuggest_attribute_returns_nonnull = 946,/* -Wsuggest-attribute=returns_nonnull */
  OPT_Wsuggest_final_methods = 947,          /* -Wsuggest-final-methods */
  OPT_Wsuggest_final_types = 948,            /* -Wsuggest-final-types */
  OPT_Wsuggest_override = 949,               /* -Wsuggest-override */
  OPT_Wsurprising = 950,                     /* -Wsurprising */
  OPT_Wswitch = 951,                         /* -Wswitch */
  OPT_Wswitch_bool = 952,                    /* -Wswitch-bool */
  OPT_Wswitch_default = 953,                 /* -Wswitch-default */
  OPT_Wswitch_enum = 954,                    /* -Wswitch-enum */
  OPT_Wswitch_outside_range = 955,           /* -Wswitch-outside-range */
  OPT_Wswitch_unreachable = 956,             /* -Wswitch-unreachable */
  OPT_Wsync_nand = 957,                      /* -Wsync-nand */
  /* OPT_Wsynth = 958, */                    /* -Wsynth */
  OPT_Wsystem_headers = 959,                 /* -Wsystem-headers */
  OPT_Wtabs = 960,                           /* -Wtabs */
  OPT_Wtarget_lifetime = 961,                /* -Wtarget-lifetime */
  OPT_Wtautological_compare = 962,           /* -Wtautological-compare */
  OPT_Wtemplate_body = 963,                  /* -Wtemplate-body */
  OPT_Wtemplate_id_cdtor = 964,              /* -Wtemplate-id-cdtor */
  OPT_Wtemplate_names_tu_local = 965,        /* -Wtemplate-names-tu-local */
  OPT_Wtemplates = 966,                      /* -Wtemplates */
  OPT_Wterminate = 967,                      /* -Wterminate */
  OPT_Wtraditional = 968,                    /* -Wtraditional */
  OPT_Wtraditional_conversion = 969,         /* -Wtraditional-conversion */
  /* OPT_Wtrailing_whitespace = 970, */      /* -Wtrailing-whitespace */
  OPT_Wtrailing_whitespace_ = 971,           /* -Wtrailing-whitespace= */
  OPT_Wtrampolines = 972,                    /* -Wtrampolines */
  OPT_Wtrigraphs = 973,                      /* -Wtrigraphs */
  OPT_Wtrivial_auto_var_init = 974,          /* -Wtrivial-auto-var-init */
  OPT_Wtsan = 975,                           /* -Wtsan */
  OPT_Wtype_limits = 976,                    /* -Wtype-limits */
  OPT_Wundeclared_selector = 977,            /* -Wundeclared-selector */
  OPT_Wundef = 978,                          /* -Wundef */
  OPT_Wundefined_do_loop = 979,              /* -Wundefined-do-loop */
  OPT_Wunderflow = 980,                      /* -Wunderflow */
  OPT_Wunicode = 981,                        /* -Wunicode */
  OPT_Wuninit_variable_checking = 982,       /* -Wuninit-variable-checking */
  OPT_Wuninit_variable_checking_ = 983,      /* -Wuninit-variable-checking= */
  OPT_Wuninitialized = 984,                  /* -Wuninitialized */
  OPT_Wunknown_pragmas = 985,                /* -Wunknown-pragmas */
  /* OPT_Wunreachable_code = 986, */         /* -Wunreachable-code */
  /* OPT_Wunsafe_loop_optimizations = 987, *//* -Wunsafe-loop-optimizations */
  OPT_Wunsuffixed_float_constants = 988,     /* -Wunsuffixed-float-constants */
  OPT_Wunterminated_string_initialization = 989,/* -Wunterminated-string-initialization */
  OPT_Wunused = 990,                         /* -Wunused */
  /* OPT_Wunused_but_set_parameter = 991, */ /* -Wunused-but-set-parameter */
  OPT_Wunused_but_set_parameter_ = 992,      /* -Wunused-but-set-parameter= */
  /* OPT_Wunused_but_set_variable = 993, */  /* -Wunused-but-set-variable */
  OPT_Wunused_but_set_variable_ = 994,       /* -Wunused-but-set-variable= */
  /* OPT_Wunused_const_variable = 995, */    /* -Wunused-const-variable */
  OPT_Wunused_const_variable_ = 996,         /* -Wunused-const-variable= */
  OPT_Wunused_dummy_argument = 997,          /* -Wunused-dummy-argument */
  OPT_Wunused_function = 998,                /* -Wunused-function */
  OPT_Wunused_label = 999,                   /* -Wunused-label */
  OPT_Wunused_local_typedefs = 1000,         /* -Wunused-local-typedefs */
  OPT_Wunused_macros = 1001,                 /* -Wunused-macros */
  OPT_Wunused_parameter = 1002,              /* -Wunused-parameter */
  OPT_Wunused_result = 1003,                 /* -Wunused-result */
  OPT_Wunused_value = 1004,                  /* -Wunused-value */
  OPT_Wunused_variable = 1005,               /* -Wunused-variable */
  OPT_Wusage_typename = 1006,                /* -Wusage-typename */
  OPT_Wuse_after_free = 1007,                /* -Wuse-after-free */
  OPT_Wuse_after_free_ = 1008,               /* -Wuse-after-free= */
  OPT_Wuse_without_only = 1009,              /* -Wuse-without-only */
  OPT_Wuseless_cast = 1010,                  /* -Wuseless-cast */
  OPT_Wvarargs = 1011,                       /* -Wvarargs */
  OPT_Wvariadic_macros = 1012,               /* -Wvariadic-macros */
  OPT_Wvector_operation_performance = 1013,  /* -Wvector-operation-performance */
  OPT_Wverbose_unbounded = 1014,             /* -Wverbose-unbounded */
  OPT_Wvexing_parse = 1015,                  /* -Wvexing-parse */
  OPT_Wvirtual_inheritance = 1016,           /* -Wvirtual-inheritance */
  OPT_Wvirtual_move_assign = 1017,           /* -Wvirtual-move-assign */
  OPT_Wvla = 1018,                           /* -Wvla */
  OPT_Wvla_larger_than_ = 1019,              /* -Wvla-larger-than= */
  OPT_Wvla_parameter = 1020,                 /* -Wvla-parameter */
  OPT_Wvoiding = 1021,                       /* -Wvoiding */
  OPT_Wvolatile = 1022,                      /* -Wvolatile */
  OPT_Wvolatile_register_var = 1023,         /* -Wvolatile-register-var */
  OPT_Wwrite_strings = 1024,                 /* -Wwrite-strings */
  OPT_Wxor_used_as_pow = 1025,               /* -Wxor-used-as-pow */
  OPT_Wzero_as_null_pointer_constant = 1026, /* -Wzero-as-null-pointer-constant */
  OPT_Wzero_length_bounds = 1027,            /* -Wzero-length-bounds */
  OPT_Wzerotrip = 1028,                      /* -Wzerotrip */
  OPT_X = 1029,                              /* -X */
  OPT_Xassembler = 1030,                     /* -Xassembler */
  OPT_Xf = 1031,                             /* -Xf */
  OPT_Xlinker = 1032,                        /* -Xlinker */
  OPT_Xpreprocessor = 1033,                  /* -Xpreprocessor */
  OPT_Z = 1034,                              /* -Z */
  OPT_ansi = 1035,                           /* -ansi */
  OPT_aux_info = 1036,                       /* -aux-info */
  /* OPT_aux_info_ = 1037, */                /* -aux-info= */
  OPT_c = 1038,                              /* -c */
  OPT_callgraph = 1039,                      /* -callgraph */
  OPT_copyext = 1040,                        /* -copyext */
  OPT_coverage = 1041,                       /* -coverage */
  OPT_cpp = 1042,                            /* -cpp */
  OPT_cpp_ = 1043,                           /* -cpp= */
  OPT_d = 1044,                              /* -d */
  OPT_debuglib_ = 1045,                      /* -debuglib= */
  OPT_defaultlib_ = 1046,                    /* -defaultlib= */
  OPT_defined_only = 1047,                   /* -defined-only */
  OPT_demangle = 1048,                       /* -demangle */
  OPT_dialect = 1049,                        /* -dialect */
  OPT_dstartfiles = 1050,                    /* -dstartfiles */
  OPT_dump_body_ = 1051,                     /* -dump-body= */
  OPT_dump_level_ = 1052,                    /* -dump-level= */
  OPT_dumpbase = 1053,                       /* -dumpbase */
  OPT_dumpbase_ext = 1054,                   /* -dumpbase-ext */
  OPT_dumpdir = 1055,                        /* -dumpdir */
  OPT_dumpfullversion = 1056,                /* -dumpfullversion */
  OPT_dumpmachine = 1057,                    /* -dumpmachine */
  OPT_dumpspecs = 1058,                      /* -dumpspecs */
  OPT_dumpversion = 1059,                    /* -dumpversion */
  OPT_e = 1060,                              /* -e */
  OPT_export_dynamic = 1061,                 /* -export-dynamic */
  OPT_fPIC = 1062,                           /* -fPIC */
  OPT_fPIE = 1063,                           /* -fPIE */
  OPT_fRTS_ = 1064,                          /* -fRTS= */
  OPT_fa68_dump_ast = 1065,                  /* -fa68-dump-ast */
  OPT_fa68_dump_modes = 1066,                /* -fa68-dump-modes */
  OPT_fa68_dump_module_interfaces = 1067,    /* -fa68-dump-module-interfaces */
  OPT_fabi_compat_version_ = 1068,           /* -fabi-compat-version= */
  OPT_fabi_version_ = 1069,                  /* -fabi-version= */
  OPT_faccess_control = 1070,                /* -faccess-control */
  OPT_fada_spec_parent_ = 1071,              /* -fada-spec-parent= */
  OPT_faggressive_function_elimination = 1072,/* -faggressive-function-elimination */
  OPT_faggressive_loop_optimizations = 1073, /* -faggressive-loop-optimizations */
  OPT_falign_commons = 1074,                 /* -falign-commons */
  OPT_falign_functions = 1075,               /* -falign-functions */
  OPT_falign_functions_ = 1076,              /* -falign-functions= */
  OPT_falign_jumps = 1077,                   /* -falign-jumps */
  OPT_falign_jumps_ = 1078,                  /* -falign-jumps= */
  OPT_falign_labels = 1079,                  /* -falign-labels */
  OPT_falign_labels_ = 1080,                 /* -falign-labels= */
  OPT_falign_loops = 1081,                   /* -falign-loops */
  OPT_falign_loops_ = 1082,                  /* -falign-loops= */
  /* OPT_faligned_new = 1083, */             /* -faligned-new */
  OPT_faligned_new_ = 1084,                  /* -faligned-new= */
  OPT_fall_instantiations = 1085,            /* -fall-instantiations */
  OPT_fall_intrinsics = 1086,                /* -fall-intrinsics */
  OPT_fall_virtual = 1087,                   /* -fall-virtual */
  OPT_fallocation_dce = 1088,                /* -fallocation-dce */
  OPT_fallow_argument_mismatch = 1089,       /* -fallow-argument-mismatch */
  OPT_fallow_invalid_boz = 1090,             /* -fallow-invalid-boz */
  OPT_fallow_leading_underscore = 1091,      /* -fallow-leading-underscore */
  /* OPT_fallow_parameterless_variadic_functions = 1092, *//* -fallow-parameterless-variadic-functions */
  OPT_fallow_store_data_races = 1093,        /* -fallow-store-data-races */
  OPT_falt_external_templates = 1094,        /* -falt-external-templates */
  OPT_fanalyzer = 1095,                      /* -fanalyzer */
  OPT_fanalyzer_assume_nothrow = 1096,       /* -fanalyzer-assume-nothrow */
  OPT_fanalyzer_call_summaries = 1097,       /* -fanalyzer-call-summaries */
  OPT_fanalyzer_checker_ = 1098,             /* -fanalyzer-checker= */
  OPT_fanalyzer_debug_text_art = 1099,       /* -fanalyzer-debug-text-art */
  OPT_fanalyzer_feasibility = 1100,          /* -fanalyzer-feasibility */
  /* OPT_fanalyzer_fine_grained = 1101, */   /* -fanalyzer-fine-grained */
  OPT_fanalyzer_show_duplicate_count = 1102, /* -fanalyzer-show-duplicate-count */
  OPT_fanalyzer_show_events_in_system_headers = 1103,/* -fanalyzer-show-events-in-system-headers */
  OPT_fanalyzer_simplify_supergraph = 1104,  /* -fanalyzer-simplify-supergraph */
  OPT_fanalyzer_state_merge = 1105,          /* -fanalyzer-state-merge */
  OPT_fanalyzer_state_purge = 1106,          /* -fanalyzer-state-purge */
  OPT_fanalyzer_suppress_followups = 1107,   /* -fanalyzer-suppress-followups */
  OPT_fanalyzer_transitivity = 1108,         /* -fanalyzer-transitivity */
  OPT_fanalyzer_undo_inlining = 1109,        /* -fanalyzer-undo-inlining */
  OPT_fanalyzer_verbose_edges = 1110,        /* -fanalyzer-verbose-edges */
  OPT_fanalyzer_verbose_state_changes = 1111,/* -fanalyzer-verbose-state-changes */
  OPT_fanalyzer_verbosity_ = 1112,           /* -fanalyzer-verbosity= */
  /* OPT_fargument_alias = 1113, */          /* -fargument-alias */
  /* OPT_fargument_noalias = 1114, */        /* -fargument-noalias */
  /* OPT_fargument_noalias_anything = 1115, *//* -fargument-noalias-anything */
  /* OPT_fargument_noalias_global = 1116, */ /* -fargument-noalias-global */
  OPT_fasan_shadow_offset_ = 1117,           /* -fasan-shadow-offset= */
  OPT_fasm = 1118,                           /* -fasm */
  OPT_fassert = 1119,                        /* -fassert */
  OPT_fassociative_math = 1120,              /* -fassociative-math */
  OPT_fassume_sane_operators_new_delete = 1121,/* -fassume-sane-operators-new-delete */
  OPT_fasynchronous_unwind_tables = 1122,    /* -fasynchronous-unwind-tables */
  OPT_fauto_inc_dec = 1123,                  /* -fauto-inc-dec */
  OPT_fauto_init = 1124,                     /* -fauto-init */
  OPT_fauto_profile = 1125,                  /* -fauto-profile */
  OPT_fauto_profile_inlining = 1126,         /* -fauto-profile-inlining */
  OPT_fauto_profile_ = 1127,                 /* -fauto-profile= */
  OPT_fautomatic = 1128,                     /* -fautomatic */
  OPT_favoid_store_forwarding = 1129,        /* -favoid-store-forwarding */
  OPT_fbackslash = 1130,                     /* -fbackslash */
  OPT_fbacktrace = 1131,                     /* -fbacktrace */
  OPT_fbit_tests = 1132,                     /* -fbit-tests */
  OPT_fblas_matmul_limit_ = 1133,            /* -fblas-matmul-limit= */
  OPT_fbounds = 1134,                        /* -fbounds */
  OPT_fbounds_check = 1135,                  /* -fbounds-check */
  OPT_fbounds_check_ = 1136,                 /* -fbounds-check= */
  OPT_fbrackets = 1137,                      /* -fbrackets */
  OPT_fbranch_count_reg = 1138,              /* -fbranch-count-reg */
  OPT_fbranch_probabilities = 1139,          /* -fbranch-probabilities */
  /* OPT_fbranch_target_load_optimize = 1140, *//* -fbranch-target-load-optimize */
  /* OPT_fbranch_target_load_optimize2 = 1141, *//* -fbranch-target-load-optimize2 */
  /* OPT_fbtr_bb_exclusive = 1142, */        /* -fbtr-bb-exclusive */
  OPT_fbuilding_libga68 = 1143,              /* -fbuilding-libga68 */
  OPT_fbuilding_libgcc = 1144,               /* -fbuilding-libgcc */
  OPT_fbuilding_libgfortran = 1145,          /* -fbuilding-libgfortran */
  OPT_fbuilding_libphobos_tests = 1146,      /* -fbuilding-libphobos-tests */
  OPT_fbuiltin = 1147,                       /* -fbuiltin */
  OPT_fbuiltin_ = 1148,                      /* -fbuiltin- */
  OPT_fbuiltin_printf = 1149,                /* -fbuiltin-printf */
  OPT_fc_prototypes = 1150,                  /* -fc-prototypes */
  OPT_fc_prototypes_external = 1151,         /* -fc-prototypes-external */
  OPT_fcall_saved_ = 1152,                   /* -fcall-saved- */
  OPT_fcall_used_ = 1153,                    /* -fcall-used- */
  OPT_fcaller_saves = 1154,                  /* -fcaller-saves */
  OPT_fcallgraph_info = 1155,                /* -fcallgraph-info */
  OPT_fcallgraph_info_ = 1156,               /* -fcallgraph-info= */
  OPT_fcanon_prefix_map = 1157,              /* -fcanon-prefix-map */
  OPT_fcanonical_system_headers = 1158,      /* -fcanonical-system-headers */
  OPT_fcase = 1159,                          /* -fcase */
  /* OPT_fcf_protection = 1160, */           /* -fcf-protection */
  OPT_fcf_protection_ = 1161,                /* -fcf-protection= */
  OPT_fchar8_t = 1162,                       /* -fchar8_t */
  OPT_fcheck_array_temporaries = 1163,       /* -fcheck-array-temporaries */
  /* OPT_fcheck_data_deps = 1164, */         /* -fcheck-data-deps */
  OPT_fcheck_new = 1165,                     /* -fcheck-new */
  OPT_fcheck_pointer_bounds = 1166,          /* -fcheck-pointer-bounds */
  OPT_fcheck_ = 1167,                        /* -fcheck= */
  /* OPT_fcheck_assert = 1168, */            /* -fcheck=assert */
  /* OPT_fcheck_bounds = 1169, */            /* -fcheck=bounds */
  /* OPT_fcheck_in = 1170, */                /* -fcheck=in */
  /* OPT_fcheck_invariant = 1171, */         /* -fcheck=invariant */
  /* OPT_fcheck_out = 1172, */               /* -fcheck=out */
  /* OPT_fcheck_switch = 1173, */            /* -fcheck=switch */
  OPT_fcheckaction_ = 1174,                  /* -fcheckaction= */
  OPT_fchecking = 1175,                      /* -fchecking */
  OPT_fchecking_ = 1176,                     /* -fchecking= */
  OPT_fchkp_check_incomplete_type = 1177,    /* -fchkp-check-incomplete-type */
  OPT_fchkp_check_read = 1178,               /* -fchkp-check-read */
  OPT_fchkp_check_write = 1179,              /* -fchkp-check-write */
  OPT_fchkp_first_field_has_own_bounds = 1180,/* -fchkp-first-field-has-own-bounds */
  OPT_fchkp_flexible_struct_trailing_arrays = 1181,/* -fchkp-flexible-struct-trailing-arrays */
  OPT_fchkp_instrument_calls = 1182,         /* -fchkp-instrument-calls */
  OPT_fchkp_instrument_marked_only = 1183,   /* -fchkp-instrument-marked-only */
  OPT_fchkp_narrow_bounds = 1184,            /* -fchkp-narrow-bounds */
  OPT_fchkp_narrow_to_innermost_array = 1185,/* -fchkp-narrow-to-innermost-array */
  OPT_fchkp_optimize = 1186,                 /* -fchkp-optimize */
  OPT_fchkp_store_bounds = 1187,             /* -fchkp-store-bounds */
  OPT_fchkp_treat_zero_dynamic_size_as_infinite = 1188,/* -fchkp-treat-zero-dynamic-size-as-infinite */
  OPT_fchkp_use_fast_string_functions = 1189,/* -fchkp-use-fast-string-functions */
  OPT_fchkp_use_nochk_string_functions = 1190,/* -fchkp-use-nochk-string-functions */
  OPT_fchkp_use_static_bounds = 1191,        /* -fchkp-use-static-bounds */
  OPT_fchkp_use_static_const_bounds = 1192,  /* -fchkp-use-static-const-bounds */
  OPT_fchkp_use_wrappers = 1193,             /* -fchkp-use-wrappers */
  OPT_fchkp_zero_input_bounds_for_main = 1194,/* -fchkp-zero-input-bounds-for-main */
  /* OPT_fcilkplus = 1195, */                /* -fcilkplus */
  OPT_fcoarray_ = 1196,                      /* -fcoarray= */
  OPT_fcobol_exceptions = 1197,              /* -fcobol-exceptions */
  OPT_fcode_hoisting = 1198,                 /* -fcode-hoisting */
  OPT_fcombine_stack_adjustments = 1199,     /* -fcombine-stack-adjustments */
  OPT_fcommon = 1200,                        /* -fcommon */
  OPT_fcompare_debug = 1201,                 /* -fcompare-debug */
  OPT_fcompare_debug_second = 1202,          /* -fcompare-debug-second */
  OPT_fcompare_debug_ = 1203,                /* -fcompare-debug= */
  OPT_fcompare_elim = 1204,                  /* -fcompare-elim */
  OPT_fconcepts = 1205,                      /* -fconcepts */
  OPT_fconcepts_diagnostics_depth_ = 1206,   /* -fconcepts-diagnostics-depth= */
  OPT_fconcepts_ts = 1207,                   /* -fconcepts-ts */
  OPT_fcond_mismatch = 1208,                 /* -fcond-mismatch */
  OPT_fcondition_coverage = 1209,            /* -fcondition-coverage */
  /* OPT_fconserve_space = 1210, */          /* -fconserve-space */
  OPT_fconserve_stack = 1211,                /* -fconserve-stack */
  OPT_fconstant_string_class_ = 1212,        /* -fconstant-string-class= */
  OPT_fconstexpr_cache_depth_ = 1213,        /* -fconstexpr-cache-depth= */
  OPT_fconstexpr_depth_ = 1214,              /* -fconstexpr-depth= */
  OPT_fconstexpr_fp_except = 1215,           /* -fconstexpr-fp-except */
  OPT_fconstexpr_loop_limit_ = 1216,         /* -fconstexpr-loop-limit= */
  OPT_fconstexpr_ops_limit_ = 1217,          /* -fconstexpr-ops-limit= */
  OPT_fcontract_checks_outlined = 1218,      /* -fcontract-checks-outlined */
  OPT_fcontract_disable_optimized_checks = 1219,/* -fcontract-disable-optimized-checks */
  OPT_fcontract_evaluation_semantic_ = 1220, /* -fcontract-evaluation-semantic= */
  OPT_fcontracts = 1221,                     /* -fcontracts */
  OPT_fcontracts_client_check_ = 1222,       /* -fcontracts-client-check= */
  OPT_fcontracts_conservative_ipa = 1223,    /* -fcontracts-conservative-ipa */
  OPT_fcontracts_definition_check_ = 1224,   /* -fcontracts-definition-check= */
  OPT_fconvert_ = 1225,                      /* -fconvert= */
  OPT_fcoroutines = 1226,                    /* -fcoroutines */
  OPT_fcpp = 1227,                           /* -fcpp */
  OPT_fcpp_begin = 1228,                     /* -fcpp-begin */
  OPT_fcpp_end = 1229,                       /* -fcpp-end */
  OPT_fcprop_registers = 1230,               /* -fcprop-registers */
  OPT_fcray_pointer = 1231,                  /* -fcray-pointer */
  OPT_fcrossjumping = 1232,                  /* -fcrossjumping */
  OPT_fcse_follow_jumps = 1233,              /* -fcse-follow-jumps */
  /* OPT_fcse_skip_blocks = 1234, */         /* -fcse-skip-blocks */
  /* OPT_fcx_fortran_rules = 1235, */        /* -fcx-fortran-rules */
  /* OPT_fcx_limited_range = 1236, */        /* -fcx-limited-range */
  OPT_fcx_method_ = 1237,                    /* -fcx-method= */
  OPT_fd = 1238,                             /* -fd */
  OPT_fd_lines_as_code = 1239,               /* -fd-lines-as-code */
  OPT_fd_lines_as_comments = 1240,           /* -fd-lines-as-comments */
  OPT_fdata_sections = 1241,                 /* -fdata-sections */
  OPT_fdbg_cnt_list = 1242,                  /* -fdbg-cnt-list */
  OPT_fdbg_cnt_ = 1243,                      /* -fdbg-cnt= */
  OPT_fdce = 1244,                           /* -fdce */
  OPT_fdebug = 1245,                         /* -fdebug */
  OPT_fdebug_aux_vars = 1246,                /* -fdebug-aux-vars */
  OPT_fdebug_builtins = 1247,                /* -fdebug-builtins */
  OPT_fdebug_cpp = 1248,                     /* -fdebug-cpp */
  OPT_fdebug_function_line_numbers = 1249,   /* -fdebug-function-line-numbers */
  OPT_fdebug_prefix_map_ = 1250,             /* -fdebug-prefix-map= */
  OPT_fdebug_types_section = 1251,           /* -fdebug-types-section */
  OPT_fdebug_ = 1252,                        /* -fdebug= */
  OPT_fdec = 1253,                           /* -fdec */
  OPT_fdec_blank_format_item = 1254,         /* -fdec-blank-format-item */
  OPT_fdec_char_conversions = 1255,          /* -fdec-char-conversions */
  OPT_fdec_format_defaults = 1256,           /* -fdec-format-defaults */
  OPT_fdec_include = 1257,                   /* -fdec-include */
  OPT_fdec_intrinsic_ints = 1258,            /* -fdec-intrinsic-ints */
  OPT_fdec_math = 1259,                      /* -fdec-math */
  OPT_fdec_static = 1260,                    /* -fdec-static */
  OPT_fdec_structure = 1261,                 /* -fdec-structure */
  OPT_fdeclone_ctor_dtor = 1262,             /* -fdeclone-ctor-dtor */
  /* OPT_fdeduce_init_list = 1263, */        /* -fdeduce-init-list */
  OPT_fdef_ = 1264,                          /* -fdef= */
  OPT_fdefault_double_8 = 1265,              /* -fdefault-double-8 */
  /* OPT_fdefault_inline = 1266, */          /* -fdefault-inline */
  OPT_fdefault_integer_8 = 1267,             /* -fdefault-integer-8 */
  OPT_fdefault_real_10 = 1268,               /* -fdefault-real-10 */
  OPT_fdefault_real_16 = 1269,               /* -fdefault-real-16 */
  OPT_fdefault_real_8 = 1270,                /* -fdefault-real-8 */
  OPT_fdefaultbyte = 1271,                   /* -fdefaultbyte */
  OPT_fdefer_pop = 1272,                     /* -fdefer-pop */
  OPT_fdelayed_branch = 1273,                /* -fdelayed-branch */
  OPT_fdelete_dead_exceptions = 1274,        /* -fdelete-dead-exceptions */
  OPT_fdelete_null_pointer_checks = 1275,    /* -fdelete-null-pointer-checks */
  OPT_fdep_fusion = 1276,                    /* -fdep-fusion */
  OPT_fdeps_file_ = 1277,                    /* -fdeps-file= */
  OPT_fdeps_format_ = 1278,                  /* -fdeps-format= */
  OPT_fdeps_target_ = 1279,                  /* -fdeps-target= */
  OPT_fdevirtualize = 1280,                  /* -fdevirtualize */
  OPT_fdevirtualize_at_ltrans = 1281,        /* -fdevirtualize-at-ltrans */
  OPT_fdevirtualize_speculatively = 1282,    /* -fdevirtualize-speculatively */
  OPT_fdiagnostics_add_output_ = 1283,       /* -fdiagnostics-add-output= */
  OPT_fdiagnostics_all_candidates = 1284,    /* -fdiagnostics-all-candidates */
  /* OPT_fdiagnostics_color = 1285, */       /* -fdiagnostics-color */
  OPT_fdiagnostics_color_ = 1286,            /* -fdiagnostics-color= */
  OPT_fdiagnostics_column_origin_ = 1287,    /* -fdiagnostics-column-origin= */
  OPT_fdiagnostics_column_unit_ = 1288,      /* -fdiagnostics-column-unit= */
  OPT_fdiagnostics_escape_format_ = 1289,    /* -fdiagnostics-escape-format= */
  OPT_fdiagnostics_format_ = 1290,           /* -fdiagnostics-format= */
  OPT_fdiagnostics_generate_patch = 1291,    /* -fdiagnostics-generate-patch */
  OPT_fdiagnostics_json_formatting = 1292,   /* -fdiagnostics-json-formatting */
  OPT_fdiagnostics_minimum_margin_width_ = 1293,/* -fdiagnostics-minimum-margin-width= */
  OPT_fdiagnostics_parseable_fixits = 1294,  /* -fdiagnostics-parseable-fixits */
  OPT_fdiagnostics_path_format_ = 1295,      /* -fdiagnostics-path-format= */
  OPT_fdiagnostics_plain_output = 1296,      /* -fdiagnostics-plain-output */
  OPT_fdiagnostics_set_output_ = 1297,       /* -fdiagnostics-set-output= */
  OPT_fdiagnostics_show_caret = 1298,        /* -fdiagnostics-show-caret */
  /* OPT_fdiagnostics_show_context = 1299, *//* -fdiagnostics-show-context */
  OPT_fdiagnostics_show_context_ = 1300,     /* -fdiagnostics-show-context= */
  OPT_fdiagnostics_show_cwe = 1301,          /* -fdiagnostics-show-cwe */
  OPT_fdiagnostics_show_event_links = 1302,  /* -fdiagnostics-show-event-links */
  OPT_fdiagnostics_show_highlight_colors = 1303,/* -fdiagnostics-show-highlight-colors */
  OPT_fdiagnostics_show_labels = 1304,       /* -fdiagnostics-show-labels */
  OPT_fdiagnostics_show_line_numbers = 1305, /* -fdiagnostics-show-line-numbers */
  OPT_fdiagnostics_show_location_ = 1306,    /* -fdiagnostics-show-location= */
  OPT_fdiagnostics_show_nesting = 1307,      /* -fdiagnostics-show-nesting */
  OPT_fdiagnostics_show_nesting_levels = 1308,/* -fdiagnostics-show-nesting-levels */
  OPT_fdiagnostics_show_nesting_locations = 1309,/* -fdiagnostics-show-nesting-locations */
  OPT_fdiagnostics_show_option = 1310,       /* -fdiagnostics-show-option */
  OPT_fdiagnostics_show_path_depths = 1311,  /* -fdiagnostics-show-path-depths */
  OPT_fdiagnostics_show_rules = 1312,        /* -fdiagnostics-show-rules */
  OPT_fdiagnostics_show_template_tree = 1313,/* -fdiagnostics-show-template-tree */
  OPT_fdiagnostics_text_art_charset_ = 1314, /* -fdiagnostics-text-art-charset= */
  OPT_fdiagnostics_urls_ = 1315,             /* -fdiagnostics-urls= */
  OPT_fdirectives_only = 1316,               /* -fdirectives-only */
  OPT_fdisable_ = 1317,                      /* -fdisable- */
  OPT_fdoc = 1318,                           /* -fdoc */
  OPT_fdoc_dir_ = 1319,                      /* -fdoc-dir= */
  OPT_fdoc_file_ = 1320,                     /* -fdoc-file= */
  OPT_fdoc_inc_ = 1321,                      /* -fdoc-inc= */
  OPT_fdollar_ok = 1322,                     /* -fdollar-ok */
  OPT_fdollars_in_identifiers = 1323,        /* -fdollars-in-identifiers */
  OPT_fdruntime = 1324,                      /* -fdruntime */
  OPT_fdse = 1325,                           /* -fdse */
  OPT_fdump_ = 1326,                         /* -fdump- */
  OPT_fdump_ada_spec = 1327,                 /* -fdump-ada-spec */
  OPT_fdump_ada_spec_slim = 1328,            /* -fdump-ada-spec-slim */
  OPT_fdump_analyzer = 1329,                 /* -fdump-analyzer */
  /* OPT_fdump_analyzer_callgraph = 1330, */ /* -fdump-analyzer-callgraph */
  OPT_fdump_analyzer_exploded_graph = 1331,  /* -fdump-analyzer-exploded-graph */
  OPT_fdump_analyzer_exploded_nodes = 1332,  /* -fdump-analyzer-exploded-nodes */
  OPT_fdump_analyzer_exploded_nodes_2 = 1333,/* -fdump-analyzer-exploded-nodes-2 */
  OPT_fdump_analyzer_exploded_nodes_3 = 1334,/* -fdump-analyzer-exploded-nodes-3 */
  OPT_fdump_analyzer_exploded_paths = 1335,  /* -fdump-analyzer-exploded-paths */
  OPT_fdump_analyzer_feasibility = 1336,     /* -fdump-analyzer-feasibility */
  OPT_fdump_analyzer_infinite_loop = 1337,   /* -fdump-analyzer-infinite-loop */
  OPT_fdump_analyzer_json = 1338,            /* -fdump-analyzer-json */
  OPT_fdump_analyzer_state_purge = 1339,     /* -fdump-analyzer-state-purge */
  OPT_fdump_analyzer_stderr = 1340,          /* -fdump-analyzer-stderr */
  OPT_fdump_analyzer_supergraph = 1341,      /* -fdump-analyzer-supergraph */
  OPT_fdump_analyzer_untracked = 1342,       /* -fdump-analyzer-untracked */
  OPT_fdump_c___spec_verbose = 1343,         /* -fdump-c++-spec-verbose */
  OPT_fdump_c___spec_ = 1344,                /* -fdump-c++-spec= */
  /* OPT_fdump_core = 1345, */               /* -fdump-core */
  OPT_fdump_d_original = 1346,               /* -fdump-d-original */
  OPT_fdump_final_insns = 1347,              /* -fdump-final-insns */
  OPT_fdump_final_insns_ = 1348,             /* -fdump-final-insns= */
  OPT_fdump_fortran_global = 1349,           /* -fdump-fortran-global */
  OPT_fdump_fortran_optimized = 1350,        /* -fdump-fortran-optimized */
  OPT_fdump_fortran_original = 1351,         /* -fdump-fortran-original */
  OPT_fdump_go_spec_ = 1352,                 /* -fdump-go-spec= */
  OPT_fdump_internal_locations = 1353,       /* -fdump-internal-locations */
  OPT_fdump_noaddr = 1354,                   /* -fdump-noaddr */
  /* OPT_fdump_parse_tree = 1355, */         /* -fdump-parse-tree */
  OPT_fdump_passes = 1356,                   /* -fdump-passes */
  OPT_fdump_scos = 1357,                     /* -fdump-scos */
  OPT_fdump_system_exports = 1358,           /* -fdump-system-exports */
  OPT_fdump_unnumbered = 1359,               /* -fdump-unnumbered */
  OPT_fdump_unnumbered_links = 1360,         /* -fdump-unnumbered-links */
  OPT_fdwarf2_cfi_asm = 1361,                /* -fdwarf2-cfi-asm */
  OPT_fearly_inlining = 1362,                /* -fearly-inlining */
  OPT_felide_constructors = 1363,            /* -felide-constructors */
  OPT_felide_type = 1364,                    /* -felide-type */
  /* OPT_feliminate_dwarf2_dups = 1365, */   /* -feliminate-dwarf2-dups */
  OPT_feliminate_unused_debug_symbols = 1366,/* -feliminate-unused-debug-symbols */
  OPT_feliminate_unused_debug_types = 1367,  /* -feliminate-unused-debug-types */
  OPT_femit_class_debug_always = 1368,       /* -femit-class-debug-always */
  OPT_femit_struct_debug_baseonly = 1369,    /* -femit-struct-debug-baseonly */
  OPT_femit_struct_debug_detailed_ = 1370,   /* -femit-struct-debug-detailed= */
  OPT_femit_struct_debug_reduced = 1371,     /* -femit-struct-debug-reduced */
  OPT_fenable_ = 1372,                       /* -fenable- */
  OPT_fenforce_eh_specs = 1373,              /* -fenforce-eh-specs */
  OPT_fenum_int_equiv = 1374,                /* -fenum-int-equiv */
  OPT_fexceptions = 1375,                    /* -fexceptions */
  OPT_fexcess_precision_ = 1376,             /* -fexcess-precision= */
  OPT_fexec_charset_ = 1377,                 /* -fexec-charset= */
  OPT_fexec_national_charset_ = 1378,        /* -fexec-national-charset= */
  OPT_fexpensive_optimizations = 1379,       /* -fexpensive-optimizations */
  OPT_fext_dce = 1380,                       /* -fext-dce */
  OPT_fext_numeric_literals = 1381,          /* -fext-numeric-literals */
  OPT_fextended_identifiers = 1382,          /* -fextended-identifiers */
  OPT_fextended_opaque = 1383,               /* -fextended-opaque */
  OPT_fextern_std_ = 1384,                   /* -fextern-std= */
  OPT_fextern_tls_init = 1385,               /* -fextern-tls-init */
  OPT_fexternal_blas = 1386,                 /* -fexternal-blas */
  OPT_fexternal_blas64 = 1387,               /* -fexternal-blas64 */
  OPT_fexternal_templates = 1388,            /* -fexternal-templates */
  OPT_ff2c = 1389,                           /* -ff2c */
  OPT_ffast_math = 1390,                     /* -ffast-math */
  OPT_ffat_lto_objects = 1391,               /* -ffat-lto-objects */
  OPT_ffile_prefix_map_ = 1392,              /* -ffile-prefix-map= */
  OPT_ffinite_loops = 1393,                  /* -ffinite-loops */
  OPT_ffinite_math_only = 1394,              /* -ffinite-math-only */
  OPT_ffixed_ = 1395,                        /* -ffixed- */
  OPT_ffixed_form = 1396,                    /* -ffixed-form */
  OPT_ffixed_line_length_ = 1397,            /* -ffixed-line-length- */
  OPT_ffixed_line_length_none = 1398,        /* -ffixed-line-length-none */
  OPT_fflex_debug = 1399,                    /* -fflex-debug */
  OPT_ffloat_store = 1400,                   /* -ffloat-store */
  OPT_ffloatvalue = 1401,                    /* -ffloatvalue */
  OPT_ffold_mem_offsets = 1402,              /* -ffold-mem-offsets */
  OPT_ffold_simple_inlines = 1403,           /* -ffold-simple-inlines */
  OPT_ffor_scope = 1404,                     /* -ffor-scope */
  /* OPT_fforce_addr = 1405, */              /* -fforce-addr */
  OPT_fforward_propagate = 1406,             /* -fforward-propagate */
  OPT_ffp_contract_ = 1407,                  /* -ffp-contract= */
  OPT_ffp_int_builtin_inexact = 1408,        /* -ffp-int-builtin-inexact */
  OPT_ffpe_summary_ = 1409,                  /* -ffpe-summary= */
  OPT_ffpe_trap_ = 1410,                     /* -ffpe-trap= */
  OPT_ffree_form = 1411,                     /* -ffree-form */
  OPT_ffree_line_length_ = 1412,             /* -ffree-line-length- */
  OPT_ffree_line_length_none = 1413,         /* -ffree-line-length-none */
  OPT_ffreestanding = 1414,                  /* -ffreestanding */
  OPT_ffriend_injection = 1415,              /* -ffriend-injection */
  OPT_ffrontend_loop_interchange = 1416,     /* -ffrontend-loop-interchange */
  OPT_ffrontend_optimize = 1417,             /* -ffrontend-optimize */
  OPT_ffunction_cse = 1418,                  /* -ffunction-cse */
  OPT_ffunction_sections = 1419,             /* -ffunction-sections */
  OPT_ffuse_ops_with_volatile_access = 1420, /* -ffuse-ops-with-volatile-access */
  OPT_fgcse = 1421,                          /* -fgcse */
  OPT_fgcse_after_reload = 1422,             /* -fgcse-after-reload */
  OPT_fgcse_las = 1423,                      /* -fgcse-las */
  OPT_fgcse_lm = 1424,                       /* -fgcse-lm */
  OPT_fgcse_sm = 1425,                       /* -fgcse-sm */
  OPT_fgen_module_list_ = 1426,              /* -fgen-module-list= */
  OPT_fgimple = 1427,                        /* -fgimple */
  OPT_fgnat_encodings_ = 1428,               /* -fgnat-encodings= */
  OPT_fgnu_keywords = 1429,                  /* -fgnu-keywords */
  OPT_fgnu_runtime = 1430,                   /* -fgnu-runtime */
  OPT_fgnu_tm = 1431,                        /* -fgnu-tm */
  OPT_fgnu_unique = 1432,                    /* -fgnu-unique */
  OPT_fgnu89_inline = 1433,                  /* -fgnu89-inline */
  OPT_fgo_c_header_ = 1434,                  /* -fgo-c-header= */
  OPT_fgo_check_divide_overflow = 1435,      /* -fgo-check-divide-overflow */
  OPT_fgo_check_divide_zero = 1436,          /* -fgo-check-divide-zero */
  OPT_fgo_compiling_runtime = 1437,          /* -fgo-compiling-runtime */
  OPT_fgo_debug_escape = 1438,               /* -fgo-debug-escape */
  OPT_fgo_debug_escape_hash_ = 1439,         /* -fgo-debug-escape-hash= */
  OPT_fgo_debug_optimization = 1440,         /* -fgo-debug-optimization */
  OPT_fgo_dump_ = 1441,                      /* -fgo-dump- */
  OPT_fgo_embedcfg_ = 1442,                  /* -fgo-embedcfg= */
  OPT_fgo_importcfg_ = 1443,                 /* -fgo-importcfg= */
  OPT_fgo_optimize_ = 1444,                  /* -fgo-optimize- */
  OPT_fgo_pkgpath_ = 1445,                   /* -fgo-pkgpath= */
  OPT_fgo_prefix_ = 1446,                    /* -fgo-prefix= */
  OPT_fgo_relative_import_path_ = 1447,      /* -fgo-relative-import-path= */
  OPT_fgraphite = 1448,                      /* -fgraphite */
  OPT_fgraphite_identity = 1449,             /* -fgraphite-identity */
  OPT_fguess_branch_probability = 1450,      /* -fguess-branch-probability */
  OPT_fguiding_decls = 1451,                 /* -fguiding-decls */
  /* OPT_fhandle_exceptions = 1452, */       /* -fhandle-exceptions */
  OPT_fhardcfr_check_exceptions = 1453,      /* -fhardcfr-check-exceptions */
  OPT_fhardcfr_check_noreturn_calls_ = 1454, /* -fhardcfr-check-noreturn-calls= */
  OPT_fhardcfr_check_returning_calls = 1455, /* -fhardcfr-check-returning-calls */
  OPT_fhardcfr_skip_leaf = 1456,             /* -fhardcfr-skip-leaf */
  OPT_fharden_compares = 1457,               /* -fharden-compares */
  OPT_fharden_conditional_branches = 1458,   /* -fharden-conditional-branches */
  OPT_fharden_control_flow_redundancy = 1459,/* -fharden-control-flow-redundancy */
  OPT_fhardened = 1460,                      /* -fhardened */
  /* OPT_fhelp = 1461, */                    /* -fhelp */
  /* OPT_fhelp_ = 1462, */                   /* -fhelp= */
  OPT_fhoist_adjacent_loads = 1463,          /* -fhoist-adjacent-loads */
  OPT_fhonor_std = 1464,                     /* -fhonor-std */
  OPT_fhosted = 1465,                        /* -fhosted */
  OPT_fhuge_objects = 1466,                  /* -fhuge-objects */
  OPT_fident = 1467,                         /* -fident */
  OPT_fif_conversion = 1468,                 /* -fif-conversion */
  OPT_fif_conversion2 = 1469,                /* -fif-conversion2 */
  OPT_fignore_unknown_pragmas = 1470,        /* -fignore-unknown-pragmas */
  OPT_fimmediate_escalation = 1471,          /* -fimmediate-escalation */
  OPT_fimplement_inlines = 1472,             /* -fimplement-inlines */
  OPT_fimplicit_constexpr = 1473,            /* -fimplicit-constexpr */
  OPT_fimplicit_inline_templates = 1474,     /* -fimplicit-inline-templates */
  OPT_fimplicit_none = 1475,                 /* -fimplicit-none */
  OPT_fimplicit_templates = 1476,            /* -fimplicit-templates */
  OPT_finclude_imports = 1477,               /* -finclude-imports */
  OPT_findex = 1478,                         /* -findex */
  OPT_findicator_column = 1479,              /* -findicator-column */
  OPT_findirect_inlining = 1480,             /* -findirect-inlining */
  OPT_finhibit_size_directive = 1481,        /* -finhibit-size-directive */
  OPT_finit_character_ = 1482,               /* -finit-character= */
  OPT_finit_derived = 1483,                  /* -finit-derived */
  OPT_finit_integer_ = 1484,                 /* -finit-integer= */
  OPT_finit_local_zero = 1485,               /* -finit-local-zero */
  OPT_finit_logical_ = 1486,                 /* -finit-logical= */
  OPT_finit_real_ = 1487,                    /* -finit-real= */
  OPT_finline = 1488,                        /* -finline */
  OPT_finline_arg_packing = 1489,            /* -finline-arg-packing */
  OPT_finline_atomics = 1490,                /* -finline-atomics */
  OPT_finline_functions = 1491,              /* -finline-functions */
  OPT_finline_functions_called_once = 1492,  /* -finline-functions-called-once */
  OPT_finline_intrinsics = 1493,             /* -finline-intrinsics */
  OPT_finline_intrinsics_ = 1494,            /* -finline-intrinsics= */
  /* OPT_finline_limit_ = 1495, */           /* -finline-limit- */
  OPT_finline_limit_ = 1496,                 /* -finline-limit= */
  OPT_finline_matmul_limit_ = 1497,          /* -finline-matmul-limit= */
  OPT_finline_small_functions = 1498,        /* -finline-small-functions */
  OPT_finline_stringops = 1499,              /* -finline-stringops */
  OPT_finline_stringops_ = 1500,             /* -finline-stringops= */
  OPT_finput_charset_ = 1501,                /* -finput-charset= */
  OPT_finstrument_functions = 1502,          /* -finstrument-functions */
  OPT_finstrument_functions_exclude_file_list_ = 1503,/* -finstrument-functions-exclude-file-list= */
  OPT_finstrument_functions_exclude_function_list_ = 1504,/* -finstrument-functions-exclude-function-list= */
  OPT_finstrument_functions_once = 1505,     /* -finstrument-functions-once */
  OPT_finteger_4_integer_8 = 1506,           /* -finteger-4-integer-8 */
  OPT_fintrinsic_modules_path = 1507,        /* -fintrinsic-modules-path */
  OPT_fintrinsic_modules_path_ = 1508,       /* -fintrinsic-modules-path= */
  OPT_finvariants = 1509,                    /* -finvariants */
  OPT_fipa_bit_cp = 1510,                    /* -fipa-bit-cp */
  OPT_fipa_cp = 1511,                        /* -fipa-cp */
  /* OPT_fipa_cp_alignment = 1512, */        /* -fipa-cp-alignment */
  OPT_fipa_cp_clone = 1513,                  /* -fipa-cp-clone */
  OPT_fipa_icf = 1514,                       /* -fipa-icf */
  OPT_fipa_icf_functions = 1515,             /* -fipa-icf-functions */
  OPT_fipa_icf_variables = 1516,             /* -fipa-icf-variables */
  /* OPT_fipa_matrix_reorg = 1517, */        /* -fipa-matrix-reorg */
  OPT_fipa_modref = 1518,                    /* -fipa-modref */
  OPT_fipa_profile = 1519,                   /* -fipa-profile */
  OPT_fipa_pta = 1520,                       /* -fipa-pta */
  OPT_fipa_pure_const = 1521,                /* -fipa-pure-const */
  OPT_fipa_ra = 1522,                        /* -fipa-ra */
  OPT_fipa_reference = 1523,                 /* -fipa-reference */
  OPT_fipa_reference_addressable = 1524,     /* -fipa-reference-addressable */
  OPT_fipa_reorder_for_locality = 1525,      /* -fipa-reorder-for-locality */
  OPT_fipa_sra = 1526,                       /* -fipa-sra */
  OPT_fipa_stack_alignment = 1527,           /* -fipa-stack-alignment */
  OPT_fipa_strict_aliasing = 1528,           /* -fipa-strict-aliasing */
  /* OPT_fipa_struct_reorg = 1529, */        /* -fipa-struct-reorg */
  OPT_fipa_vrp = 1530,                       /* -fipa-vrp */
  OPT_fira_algorithm_ = 1531,                /* -fira-algorithm= */
  OPT_fira_hoist_pressure = 1532,            /* -fira-hoist-pressure */
  OPT_fira_loop_pressure = 1533,             /* -fira-loop-pressure */
  OPT_fira_region_ = 1534,                   /* -fira-region= */
  OPT_fira_share_save_slots = 1535,          /* -fira-share-save-slots */
  OPT_fira_share_spill_slots = 1536,         /* -fira-share-spill-slots */
  OPT_fira_verbose_ = 1537,                  /* -fira-verbose= */
  OPT_fiso = 1538,                           /* -fiso */
  OPT_fisolate_erroneous_paths_attribute = 1539,/* -fisolate-erroneous-paths-attribute */
  OPT_fisolate_erroneous_paths_dereference = 1540,/* -fisolate-erroneous-paths-dereference */
  OPT_fivar_visibility_ = 1541,              /* -fivar-visibility= */
  OPT_fivopts = 1542,                        /* -fivopts */
  OPT_fjump_tables = 1543,                   /* -fjump-tables */
  OPT_fkeep_gc_roots_live = 1544,            /* -fkeep-gc-roots-live */
  OPT_fkeep_inline_dllexport = 1545,         /* -fkeep-inline-dllexport */
  OPT_fkeep_inline_functions = 1546,         /* -fkeep-inline-functions */
  OPT_fkeep_static_consts = 1547,            /* -fkeep-static-consts */
  OPT_fkeep_static_functions = 1548,         /* -fkeep-static-functions */
  OPT_flabels_ok = 1549,                     /* -flabels-ok */
  OPT_flang_info_include_translate = 1550,   /* -flang-info-include-translate */
  OPT_flang_info_include_translate_not = 1551,/* -flang-info-include-translate-not */
  OPT_flang_info_include_translate_ = 1552,  /* -flang-info-include-translate= */
  OPT_flang_info_module_cmi = 1553,          /* -flang-info-module-cmi */
  OPT_flang_info_module_cmi_ = 1554,         /* -flang-info-module-cmi= */
  /* OPT_flarge_source_files = 1555, */      /* -flarge-source-files */
  OPT_flate_combine_instructions = 1556,     /* -flate-combine-instructions */
  OPT_flax_vector_conversions = 1557,        /* -flax-vector-conversions */
  OPT_fleading_underscore = 1558,            /* -fleading-underscore */
  OPT_flibs_ = 1559,                         /* -flibs= */
  OPT_flifetime_dse = 1560,                  /* -flifetime-dse */
  OPT_flifetime_dse_ = 1561,                 /* -flifetime-dse= */
  OPT_flimit_function_alignment = 1562,      /* -flimit-function-alignment */
  OPT_flink_libatomic = 1563,                /* -flink-libatomic */
  OPT_flinker_output_ = 1564,                /* -flinker-output= */
  /* OPT_flive_patching = 1565, */           /* -flive-patching */
  OPT_flive_patching_ = 1566,                /* -flive-patching= */
  OPT_flive_range_shrinkage = 1567,          /* -flive-range-shrinkage */
  OPT_flocal_ivars = 1568,                   /* -flocal-ivars */
  OPT_flocation_ = 1569,                     /* -flocation= */
  /* OPT_floop_block = 1570, */              /* -floop-block */
  /* OPT_floop_flatten = 1571, */            /* -floop-flatten */
  OPT_floop_interchange = 1572,              /* -floop-interchange */
  OPT_floop_nest_optimize = 1573,            /* -floop-nest-optimize */
  /* OPT_floop_optimize = 1574, */           /* -floop-optimize */
  OPT_floop_parallelize_all = 1575,          /* -floop-parallelize-all */
  /* OPT_floop_strip_mine = 1576, */         /* -floop-strip-mine */
  OPT_floop_unroll_and_jam = 1577,           /* -floop-unroll-and-jam */
  OPT_flra_remat = 1578,                     /* -flra-remat */
  OPT_flto = 1579,                           /* -flto */
  OPT_flto_compression_level_ = 1580,        /* -flto-compression-level= */
  OPT_flto_incremental_cache_size_ = 1581,   /* -flto-incremental-cache-size= */
  OPT_flto_incremental_ = 1582,              /* -flto-incremental= */
  /* OPT_flto_odr_type_merging = 1583, */    /* -flto-odr-type-merging */
  OPT_flto_partition_ = 1584,                /* -flto-partition= */
  OPT_flto_report = 1585,                    /* -flto-report */
  OPT_flto_report_wpa = 1586,                /* -flto-report-wpa */
  OPT_flto_toplevel_asm_heuristics = 1587,   /* -flto-toplevel-asm-heuristics */
  OPT_flto_ = 1588,                          /* -flto= */
  OPT_fltrans = 1589,                        /* -fltrans */
  OPT_fltrans_output_list_ = 1590,           /* -fltrans-output-list= */
  OPT_fm2_debug_trace_ = 1591,               /* -fm2-debug-trace= */
  OPT_fm2_dump_decl_ = 1592,                 /* -fm2-dump-decl= */
  OPT_fm2_dump_filter_ = 1593,               /* -fm2-dump-filter= */
  OPT_fm2_dump_gimple_ = 1594,               /* -fm2-dump-gimple= */
  OPT_fm2_dump_quad_ = 1595,                 /* -fm2-dump-quad= */
  OPT_fm2_dump_ = 1596,                      /* -fm2-dump= */
  OPT_fm2_file_offset_bits_ = 1597,          /* -fm2-file-offset-bits= */
  OPT_fm2_g = 1598,                          /* -fm2-g */
  OPT_fm2_lower_case = 1599,                 /* -fm2-lower-case */
  OPT_fm2_pathname_root_ = 1600,             /* -fm2-pathname-root= */
  OPT_fm2_pathname_rootI_ = 1601,            /* -fm2-pathname-rootI= */
  OPT_fm2_pathname_ = 1602,                  /* -fm2-pathname= */
  OPT_fm2_pathnameI = 1603,                  /* -fm2-pathnameI */
  OPT_fm2_plugin = 1604,                     /* -fm2-plugin */
  OPT_fm2_prefix_ = 1605,                    /* -fm2-prefix= */
  OPT_fm2_statistics = 1606,                 /* -fm2-statistics */
  OPT_fm2_strict_type = 1607,                /* -fm2-strict-type */
  OPT_fm2_strict_type_reason = 1608,         /* -fm2-strict-type-reason */
  OPT_fm2_whole_program = 1609,              /* -fm2-whole-program */
  OPT_fmacro_prefix_map_ = 1610,             /* -fmacro-prefix-map= */
  OPT_fmain = 1611,                          /* -fmain */
  OPT_fmalloc_dce = 1612,                    /* -fmalloc-dce */
  OPT_fmalloc_dce_ = 1613,                   /* -fmalloc-dce= */
  OPT_fmath_errno = 1614,                    /* -fmath-errno */
  OPT_fmax_array_constructor_ = 1615,        /* -fmax-array-constructor= */
  OPT_fmax_errors_ = 1616,                   /* -fmax-errors= */
  OPT_fmax_identifier_length_ = 1617,        /* -fmax-identifier-length= */
  OPT_fmax_include_depth_ = 1618,            /* -fmax-include-depth= */
  OPT_fmax_stack_var_size_ = 1619,           /* -fmax-stack-var-size= */
  OPT_fmax_subrecord_length_ = 1620,         /* -fmax-subrecord-length= */
  OPT_fmem_report = 1621,                    /* -fmem-report */
  OPT_fmem_report_wpa = 1622,                /* -fmem-report-wpa */
  OPT_fmerge_all_constants = 1623,           /* -fmerge-all-constants */
  OPT_fmerge_constants = 1624,               /* -fmerge-constants */
  OPT_fmerge_debug_strings = 1625,           /* -fmerge-debug-strings */
  OPT_fmessage_length_ = 1626,               /* -fmessage-length= */
  OPT_fmin_function_alignment_ = 1627,       /* -fmin-function-alignment= */
  OPT_fmod_ = 1628,                          /* -fmod= */
  OPT_fmodule_file_ = 1629,                  /* -fmodule-file= */
  OPT_fmodule_header = 1630,                 /* -fmodule-header */
  OPT_fmodule_header_ = 1631,                /* -fmodule-header= */
  OPT_fmodule_implicit_inline = 1632,        /* -fmodule-implicit-inline */
  OPT_fmodule_lazy = 1633,                   /* -fmodule-lazy */
  OPT_fmodule_mapper_ = 1634,                /* -fmodule-mapper= */
  OPT_fmodule_only = 1635,                   /* -fmodule-only */
  OPT_fmodule_private = 1636,                /* -fmodule-private */
  OPT_fmodule_version_ignore = 1637,         /* -fmodule-version-ignore */
  OPT_fmoduleinfo = 1638,                    /* -fmoduleinfo */
  OPT_fmodules = 1639,                       /* -fmodules */
  OPT_fmodules_map = 1640,                   /* -fmodules-map */
  OPT_fmodules_map_file = 1641,              /* -fmodules-map-file */
  OPT_fmodules_map_file_ = 1642,             /* -fmodules-map-file= */
  OPT_fmodules_map_ = 1643,                  /* -fmodules-map= */
  /* OPT_fmodules_ts = 1644, */              /* -fmodules-ts */
  OPT_fmodulo_sched = 1645,                  /* -fmodulo-sched */
  OPT_fmodulo_sched_allow_regmoves = 1646,   /* -fmodulo-sched-allow-regmoves */
  OPT_fmove_loop_invariants = 1647,          /* -fmove-loop-invariants */
  OPT_fmove_loop_stores = 1648,              /* -fmove-loop-stores */
  OPT_fms_extensions = 1649,                 /* -fms-extensions */
  OPT_fmudflap = 1650,                       /* -fmudflap */
  OPT_fmudflapir = 1651,                     /* -fmudflapir */
  OPT_fmudflapth = 1652,                     /* -fmudflapth */
  OPT_fmultiflags = 1653,                    /* -fmultiflags */
  OPT_fname_mangling_version_ = 1654,        /* -fname-mangling-version- */
  OPT_fnew_abi = 1655,                       /* -fnew-abi */
  OPT_fnew_inheriting_ctors = 1656,          /* -fnew-inheriting-ctors */
  OPT_fnew_ttp_matching = 1657,              /* -fnew-ttp-matching */
  OPT_fnext_runtime = 1658,                  /* -fnext-runtime */
  OPT_fnil = 1659,                           /* -fnil */
  OPT_fnil_receivers = 1660,                 /* -fnil-receivers */
  OPT_fno_inline_intrinsics = 1661,          /* -fno-inline-intrinsics */
  OPT_fno_inline_stringops = 1662,           /* -fno-inline-stringops */
  OPT_fnon_call_exceptions = 1663,           /* -fnon-call-exceptions */
  OPT_fnonansi_builtins = 1664,              /* -fnonansi-builtins */
  OPT_fnonnull_objects = 1665,               /* -fnonnull-objects */
  OPT_fnothrow_opt = 1666,                   /* -fnothrow-opt */
  OPT_fobjc_abi_version_ = 1667,             /* -fobjc-abi-version= */
  OPT_fobjc_call_cxx_cdtors = 1668,          /* -fobjc-call-cxx-cdtors */
  OPT_fobjc_direct_dispatch = 1669,          /* -fobjc-direct-dispatch */
  OPT_fobjc_exceptions = 1670,               /* -fobjc-exceptions */
  OPT_fobjc_gc = 1671,                       /* -fobjc-gc */
  OPT_fobjc_nilcheck = 1672,                 /* -fobjc-nilcheck */
  OPT_fobjc_sjlj_exceptions = 1673,          /* -fobjc-sjlj-exceptions */
  OPT_fobjc_std_objc1 = 1674,                /* -fobjc-std=objc1 */
  OPT_foffload_abi_host_opts_ = 1675,        /* -foffload-abi-host-opts= */
  OPT_foffload_abi_ = 1676,                  /* -foffload-abi= */
  OPT_foffload_options_ = 1677,              /* -foffload-options= */
  OPT_foffload_ = 1678,                      /* -foffload= */
  OPT_fomit_frame_pointer = 1679,            /* -fomit-frame-pointer */
  OPT_fonly_ = 1680,                         /* -fonly= */
  OPT_fopenacc = 1681,                       /* -fopenacc */
  OPT_fopenacc_dim_ = 1682,                  /* -fopenacc-dim= */
  OPT_fopenmp = 1683,                        /* -fopenmp */
  OPT_fopenmp_allocators = 1684,             /* -fopenmp-allocators */
  OPT_fopenmp_simd = 1685,                   /* -fopenmp-simd */
  /* OPT_fopenmp_target_simd_clone = 1686, *//* -fopenmp-target-simd-clone */
  OPT_fopenmp_target_simd_clone_ = 1687,     /* -fopenmp-target-simd-clone= */
  OPT_foperator_names = 1688,                /* -foperator-names */
  OPT_fopt_info = 1689,                      /* -fopt-info */
  OPT_fopt_info_ = 1690,                     /* -fopt-info- */
  OPT_foptimize_crc = 1691,                  /* -foptimize-crc */
  /* OPT_foptimize_register_move = 1692, */  /* -foptimize-register-move */
  OPT_foptimize_sibling_calls = 1693,        /* -foptimize-sibling-calls */
  OPT_foptimize_strlen = 1694,               /* -foptimize-strlen */
  /* OPT_foptional_diags = 1695, */          /* -foptional-diags */
  OPT_fpack_derived = 1696,                  /* -fpack-derived */
  OPT_fpack_struct = 1697,                   /* -fpack-struct */
  OPT_fpack_struct_ = 1698,                  /* -fpack-struct= */
  OPT_fpad_source = 1699,                    /* -fpad-source */
  OPT_fpartial_inlining = 1700,              /* -fpartial-inlining */
  OPT_fpatchable_function_entry_ = 1701,     /* -fpatchable-function-entry= */
  OPT_fpath_coverage = 1702,                 /* -fpath-coverage */
  OPT_fpath_coverage_limit_ = 1703,          /* -fpath-coverage-limit= */
  OPT_fpcc_struct_return = 1704,             /* -fpcc-struct-return */
  OPT_fpch_deps = 1705,                      /* -fpch-deps */
  OPT_fpch_preprocess = 1706,                /* -fpch-preprocess */
  OPT_fpeel_loops = 1707,                    /* -fpeel-loops */
  OPT_fpeephole = 1708,                      /* -fpeephole */
  OPT_fpeephole2 = 1709,                     /* -fpeephole2 */
  OPT_fpermissive = 1710,                    /* -fpermissive */
  OPT_fpermitted_flt_eval_methods_ = 1711,   /* -fpermitted-flt-eval-methods= */
  OPT_fpic = 1712,                           /* -fpic */
  OPT_fpie = 1713,                           /* -fpie */
  OPT_fpim = 1714,                           /* -fpim */
  OPT_fpim2 = 1715,                          /* -fpim2 */
  OPT_fpim3 = 1716,                          /* -fpim3 */
  OPT_fpim4 = 1717,                          /* -fpim4 */
  OPT_fplan9_extensions = 1718,              /* -fplan9-extensions */
  OPT_fplt = 1719,                           /* -fplt */
  OPT_fplugin_arg_ = 1720,                   /* -fplugin-arg- */
  OPT_fplugin_ = 1721,                       /* -fplugin= */
  OPT_fpositive_mod_floor_div = 1722,        /* -fpositive-mod-floor-div */
  OPT_fpost_ipa_mem_report = 1723,           /* -fpost-ipa-mem-report */
  OPT_fpostconditions = 1724,                /* -fpostconditions */
  OPT_fpre_include_ = 1725,                  /* -fpre-include= */
  OPT_fpre_ipa_mem_report = 1726,            /* -fpre-ipa-mem-report */
  OPT_fpreconditions = 1727,                 /* -fpreconditions */
  OPT_fpredictive_commoning = 1728,          /* -fpredictive-commoning */
  OPT_fprefetch_loop_arrays = 1729,          /* -fprefetch-loop-arrays */
  OPT_fpreprocessed = 1730,                  /* -fpreprocessed */
  OPT_fpretty_templates = 1731,              /* -fpretty-templates */
  OPT_fpreview_all = 1732,                   /* -fpreview=all */
  OPT_fpreview_bitfields = 1733,             /* -fpreview=bitfields */
  OPT_fpreview_dip1000 = 1734,               /* -fpreview=dip1000 */
  OPT_fpreview_dip1008 = 1735,               /* -fpreview=dip1008 */
  OPT_fpreview_dip1021 = 1736,               /* -fpreview=dip1021 */
  OPT_fpreview_dtorfields = 1737,            /* -fpreview=dtorfields */
  OPT_fpreview_fieldwise = 1738,             /* -fpreview=fieldwise */
  OPT_fpreview_fixaliasthis = 1739,          /* -fpreview=fixaliasthis */
  OPT_fpreview_fiximmutableconv = 1740,      /* -fpreview=fiximmutableconv */
  OPT_fpreview_in = 1741,                    /* -fpreview=in */
  OPT_fpreview_inclusiveincontracts = 1742,  /* -fpreview=inclusiveincontracts */
  OPT_fpreview_nosharedaccess = 1743,        /* -fpreview=nosharedaccess */
  OPT_fpreview_rvaluerefparam = 1744,        /* -fpreview=rvaluerefparam */
  OPT_fpreview_safer = 1745,                 /* -fpreview=safer */
  OPT_fpreview_systemvariables = 1746,       /* -fpreview=systemvariables */
  OPT_fprintf_return_value = 1747,           /* -fprintf-return-value */
  OPT_fprofile = 1748,                       /* -fprofile */
  OPT_fprofile_abs_path = 1749,              /* -fprofile-abs-path */
  OPT_fprofile_arcs = 1750,                  /* -fprofile-arcs */
  OPT_fprofile_correction = 1751,            /* -fprofile-correction */
  OPT_fprofile_dir_ = 1752,                  /* -fprofile-dir= */
  OPT_fprofile_exclude_files_ = 1753,        /* -fprofile-exclude-files= */
  OPT_fprofile_filter_files_ = 1754,         /* -fprofile-filter-files= */
  OPT_fprofile_generate = 1755,              /* -fprofile-generate */
  OPT_fprofile_generate_ = 1756,             /* -fprofile-generate= */
  OPT_fprofile_info_section = 1757,          /* -fprofile-info-section */
  OPT_fprofile_info_section_ = 1758,         /* -fprofile-info-section= */
  OPT_fprofile_note_ = 1759,                 /* -fprofile-note= */
  OPT_fprofile_partial_training = 1760,      /* -fprofile-partial-training */
  OPT_fprofile_prefix_map_ = 1761,           /* -fprofile-prefix-map= */
  OPT_fprofile_prefix_path_ = 1762,          /* -fprofile-prefix-path= */
  OPT_fprofile_reorder_functions = 1763,     /* -fprofile-reorder-functions */
  OPT_fprofile_report = 1764,                /* -fprofile-report */
  OPT_fprofile_reproducible_ = 1765,         /* -fprofile-reproducible= */
  OPT_fprofile_update_ = 1766,               /* -fprofile-update= */
  OPT_fprofile_use = 1767,                   /* -fprofile-use */
  OPT_fprofile_use_ = 1768,                  /* -fprofile-use= */
  OPT_fprofile_values = 1769,                /* -fprofile-values */
  OPT_fprotect_parens = 1770,                /* -fprotect-parens */
  OPT_fpthread = 1771,                       /* -fpthread */
  OPT_fq = 1772,                             /* -fq */
  OPT_frandom_seed = 1773,                   /* -frandom-seed */
  OPT_frandom_seed_ = 1774,                  /* -frandom-seed= */
  OPT_frange = 1775,                         /* -frange */
  OPT_frange_check = 1776,                   /* -frange-check */
  OPT_frange_for_ext_temps = 1777,           /* -frange-for-ext-temps */
  OPT_freal_4_real_10 = 1778,                /* -freal-4-real-10 */
  OPT_freal_4_real_16 = 1779,                /* -freal-4-real-16 */
  OPT_freal_4_real_8 = 1780,                 /* -freal-4-real-8 */
  OPT_freal_8_real_10 = 1781,                /* -freal-8-real-10 */
  OPT_freal_8_real_16 = 1782,                /* -freal-8-real-16 */
  OPT_freal_8_real_4 = 1783,                 /* -freal-8-real-4 */
  OPT_frealloc_lhs = 1784,                   /* -frealloc-lhs */
  OPT_freciprocal_math = 1785,               /* -freciprocal-math */
  OPT_frecord_gcc_switches = 1786,           /* -frecord-gcc-switches */
  OPT_frecord_marker_4 = 1787,               /* -frecord-marker=4 */
  OPT_frecord_marker_8 = 1788,               /* -frecord-marker=8 */
  OPT_frecursive = 1789,                     /* -frecursive */
  OPT_free = 1790,                           /* -free */
  OPT_freflection = 1791,                    /* -freflection */
  /* OPT_freg_struct_return = 1792, */       /* -freg-struct-return */
  /* OPT_fregmove = 1793, */                 /* -fregmove */
  OPT_frelease = 1794,                       /* -frelease */
  OPT_frename_registers = 1795,              /* -frename-registers */
  OPT_freorder_blocks = 1796,                /* -freorder-blocks */
  OPT_freorder_blocks_algorithm_ = 1797,     /* -freorder-blocks-algorithm= */
  OPT_freorder_blocks_and_partition = 1798,  /* -freorder-blocks-and-partition */
  OPT_freorder_functions = 1799,             /* -freorder-functions */
  OPT_frepack_arrays = 1800,                 /* -frepack-arrays */
  OPT_freplace_objc_classes = 1801,          /* -freplace-objc-classes */
  OPT_frepo = 1802,                          /* -frepo */
  OPT_freport_bug = 1803,                    /* -freport-bug */
  OPT_frequire_return_statement = 1804,      /* -frequire-return-statement */
  OPT_frerun_cse_after_loop = 1805,          /* -frerun-cse-after-loop */
  /* OPT_frerun_loop_opt = 1806, */          /* -frerun-loop-opt */
  OPT_freschedule_modulo_scheduled_loops = 1807,/* -freschedule-modulo-scheduled-loops */
  OPT_fresolution_ = 1808,                   /* -fresolution= */
  OPT_freturn = 1809,                        /* -freturn */
  OPT_frevert_all = 1810,                    /* -frevert=all */
  OPT_frevert_dip1000 = 1811,                /* -frevert=dip1000 */
  OPT_frevert_dtorfields = 1812,             /* -frevert=dtorfields */
  OPT_frevert_intpromote = 1813,             /* -frevert=intpromote */
  OPT_frounding_math = 1814,                 /* -frounding-math */
  OPT_frtti = 1815,                          /* -frtti */
  OPT_fruntime_modules_ = 1816,              /* -fruntime-modules= */
  OPT_frust_assume_builtin_offset_of = 1817, /* -frust-assume-builtin-offset-of */
  OPT_frust_borrowcheck = 1818,              /* -frust-borrowcheck */
  OPT_frust_cfg_ = 1819,                     /* -frust-cfg= */
  OPT_frust_compile_until_ = 1820,           /* -frust-compile-until= */
  OPT_frust_crate_attr_ = 1821,              /* -frust-crate-attr= */
  OPT_frust_crate_type_ = 1822,              /* -frust-crate-type= */
  OPT_frust_crate_ = 1823,                   /* -frust-crate= */
  OPT_frust_debug = 1824,                    /* -frust-debug */
  OPT_frust_dump_ = 1825,                    /* -frust-dump- */
  OPT_frust_edition_ = 1826,                 /* -frust-edition= */
  OPT_frust_embed_metadata = 1827,           /* -frust-embed-metadata */
  OPT_frust_extern_ = 1828,                  /* -frust-extern= */
  OPT_frust_incomplete_and_experimental_compiler_do_not_use = 1829,/* -frust-incomplete-and-experimental-compiler-do-not-use */
  OPT_frust_mangling_ = 1830,                /* -frust-mangling= */
  OPT_frust_max_recursion_depth_ = 1831,     /* -frust-max-recursion-depth= */
  OPT_frust_metadata_output_ = 1832,         /* -frust-metadata-output= */
  OPT_frust_name_resolution_2_0 = 1833,      /* -frust-name-resolution-2.0 */
  OPT_frust_overflow_checks = 1834,          /* -frust-overflow-checks */
  OPT_frust_panic_ = 1835,                   /* -frust-panic= */
  OPT_frust_unused_check_2_0 = 1836,         /* -frust-unused-check-2.0 */
  OPT_fsanitize_address_use_after_scope = 1837,/* -fsanitize-address-use-after-scope */
  OPT_fsanitize_coverage_ = 1838,            /* -fsanitize-coverage= */
  OPT_fsanitize_recover = 1839,              /* -fsanitize-recover */
  OPT_fsanitize_recover_ = 1840,             /* -fsanitize-recover= */
  OPT_fsanitize_sections_ = 1841,            /* -fsanitize-sections= */
  OPT_fsanitize_trap = 1842,                 /* -fsanitize-trap */
  OPT_fsanitize_trap_ = 1843,                /* -fsanitize-trap= */
  /* OPT_fsanitize_undefined_trap_on_error = 1844, *//* -fsanitize-undefined-trap-on-error */
  OPT_fsanitize_ = 1845,                     /* -fsanitize= */
  OPT_fsave_mixins_ = 1846,                  /* -fsave-mixins= */
  OPT_fsave_optimization_record = 1847,      /* -fsave-optimization-record */
  OPT_fscaffold_c = 1848,                    /* -fscaffold-c */
  OPT_fscaffold_c__ = 1849,                  /* -fscaffold-c++ */
  OPT_fscaffold_dynamic = 1850,              /* -fscaffold-dynamic */
  OPT_fscaffold_main = 1851,                 /* -fscaffold-main */
  OPT_fscaffold_static = 1852,               /* -fscaffold-static */
  OPT_fsched_critical_path_heuristic = 1853, /* -fsched-critical-path-heuristic */
  OPT_fsched_dep_count_heuristic = 1854,     /* -fsched-dep-count-heuristic */
  OPT_fsched_group_heuristic = 1855,         /* -fsched-group-heuristic */
  OPT_fsched_interblock = 1856,              /* -fsched-interblock */
  OPT_fsched_last_insn_heuristic = 1857,     /* -fsched-last-insn-heuristic */
  OPT_fsched_pressure = 1858,                /* -fsched-pressure */
  OPT_fsched_rank_heuristic = 1859,          /* -fsched-rank-heuristic */
  OPT_fsched_spec = 1860,                    /* -fsched-spec */
  OPT_fsched_spec_insn_heuristic = 1861,     /* -fsched-spec-insn-heuristic */
  OPT_fsched_spec_load = 1862,               /* -fsched-spec-load */
  OPT_fsched_spec_load_dangerous = 1863,     /* -fsched-spec-load-dangerous */
  OPT_fsched_stalled_insns = 1864,           /* -fsched-stalled-insns */
  OPT_fsched_stalled_insns_dep = 1865,       /* -fsched-stalled-insns-dep */
  OPT_fsched_stalled_insns_dep_ = 1866,      /* -fsched-stalled-insns-dep= */
  OPT_fsched_stalled_insns_ = 1867,          /* -fsched-stalled-insns= */
  OPT_fsched_verbose_ = 1868,                /* -fsched-verbose= */
  OPT_fsched2_use_superblocks = 1869,        /* -fsched2-use-superblocks */
  /* OPT_fsched2_use_traces = 1870, */       /* -fsched2-use-traces */
  OPT_fschedule_fusion = 1871,               /* -fschedule-fusion */
  OPT_fschedule_insns = 1872,                /* -fschedule-insns */
  OPT_fschedule_insns2 = 1873,               /* -fschedule-insns2 */
  OPT_fsearch_include_path = 1874,           /* -fsearch-include-path */
  OPT_fsearch_include_path_ = 1875,          /* -fsearch-include-path= */
  OPT_fsecond_underscore = 1876,             /* -fsecond-underscore */
  OPT_fsection_anchors = 1877,               /* -fsection-anchors */
  /* OPT_fsee = 1878, */                     /* -fsee */
  OPT_fsel_sched_pipelining = 1879,          /* -fsel-sched-pipelining */
  OPT_fsel_sched_pipelining_outer_loops = 1880,/* -fsel-sched-pipelining-outer-loops */
  OPT_fsel_sched_reschedule_pipelined = 1881,/* -fsel-sched-reschedule-pipelined */
  OPT_fselective_scheduling = 1882,          /* -fselective-scheduling */
  OPT_fselective_scheduling2 = 1883,         /* -fselective-scheduling2 */
  OPT_fself_test_ = 1884,                    /* -fself-test= */
  OPT_fsemantic_interposition = 1885,        /* -fsemantic-interposition */
  OPT_fshared = 1886,                        /* -fshared */
  OPT_fshort_enums = 1887,                   /* -fshort-enums */
  OPT_fshort_wchar = 1888,                   /* -fshort-wchar */
  OPT_fshow_column = 1889,                   /* -fshow-column */
  OPT_fshrink_wrap = 1890,                   /* -fshrink-wrap */
  OPT_fshrink_wrap_separate = 1891,          /* -fshrink-wrap-separate */
  OPT_fsign_zero = 1892,                     /* -fsign-zero */
  OPT_fsignaling_nans = 1893,                /* -fsignaling-nans */
  OPT_fsigned_bitfields = 1894,              /* -fsigned-bitfields */
  OPT_fsigned_char = 1895,                   /* -fsigned-char */
  OPT_fsigned_zeros = 1896,                  /* -fsigned-zeros */
  OPT_fsimd_cost_model_ = 1897,              /* -fsimd-cost-model= */
  OPT_fsingle_precision_constant = 1898,     /* -fsingle-precision-constant */
  OPT_fsized_deallocation = 1899,            /* -fsized-deallocation */
  OPT_fsoft_check_all = 1900,                /* -fsoft-check-all */
  OPT_fsources = 1901,                       /* -fsources */
  OPT_fspeculatively_call_stored_functions = 1902,/* -fspeculatively-call-stored-functions */
  OPT_fsplit_ivs_in_unroller = 1903,         /* -fsplit-ivs-in-unroller */
  OPT_fsplit_loops = 1904,                   /* -fsplit-loops */
  OPT_fsplit_paths = 1905,                   /* -fsplit-paths */
  OPT_fsplit_stack = 1906,                   /* -fsplit-stack */
  OPT_fsplit_wide_types = 1907,              /* -fsplit-wide-types */
  OPT_fsplit_wide_types_early = 1908,        /* -fsplit-wide-types-early */
  OPT_fsquangle = 1909,                      /* -fsquangle */
  OPT_fssa_backprop = 1910,                  /* -fssa-backprop */
  OPT_fssa_phiopt = 1911,                    /* -fssa-phiopt */
  OPT_fsso_struct_ = 1912,                   /* -fsso-struct= */
  OPT_fstack_arrays = 1913,                  /* -fstack-arrays */
  /* OPT_fstack_check = 1914, */             /* -fstack-check */
  OPT_fstack_check_ = 1915,                  /* -fstack-check= */
  OPT_fstack_clash_protection = 1916,        /* -fstack-clash-protection */
  OPT_fstack_limit = 1917,                   /* -fstack-limit */
  OPT_fstack_limit_register_ = 1918,         /* -fstack-limit-register= */
  OPT_fstack_limit_symbol_ = 1919,           /* -fstack-limit-symbol= */
  OPT_fstack_protector = 1920,               /* -fstack-protector */
  OPT_fstack_protector_all = 1921,           /* -fstack-protector-all */
  OPT_fstack_protector_explicit = 1922,      /* -fstack-protector-explicit */
  OPT_fstack_protector_strong = 1923,        /* -fstack-protector-strong */
  OPT_fstack_reuse_ = 1924,                  /* -fstack-reuse= */
  OPT_fstack_usage = 1925,                   /* -fstack-usage */
  OPT_fstatic_call = 1926,                   /* -fstatic-call */
  OPT_fstats = 1927,                         /* -fstats */
  OPT_fstdarg_opt = 1928,                    /* -fstdarg-opt */
  OPT_fstore_merging = 1929,                 /* -fstore-merging */
  /* OPT_fstrength_reduce = 1930, */         /* -fstrength-reduce */
  OPT_fstrict_aliasing = 1931,               /* -fstrict-aliasing */
  OPT_fstrict_enums = 1932,                  /* -fstrict-enums */
  /* OPT_fstrict_flex_arrays = 1933, */      /* -fstrict-flex-arrays */
  OPT_fstrict_flex_arrays_ = 1934,           /* -fstrict-flex-arrays= */
  OPT_fstrict_overflow = 1935,               /* -fstrict-overflow */
  OPT_fstrict_prototype = 1936,              /* -fstrict-prototype */
  OPT_fstrict_volatile_bitfields = 1937,     /* -fstrict-volatile-bitfields */
  /* OPT_fstrong_eval_order = 1938, */       /* -fstrong-eval-order */
  OPT_fstrong_eval_order_ = 1939,            /* -fstrong-eval-order= */
  OPT_fstropping_ = 1940,                    /* -fstropping= */
  OPT_fstrub_all = 1941,                     /* -fstrub=all */
  OPT_fstrub_at_calls = 1942,                /* -fstrub=at-calls */
  OPT_fstrub_disable = 1943,                 /* -fstrub=disable */
  OPT_fstrub_internal = 1944,                /* -fstrub=internal */
  OPT_fstrub_relaxed = 1945,                 /* -fstrub=relaxed */
  OPT_fstrub_strict = 1946,                  /* -fstrub=strict */
  OPT_fswig = 1947,                          /* -fswig */
  OPT_fswitch_errors = 1948,                 /* -fswitch-errors */
  OPT_fsync_libcalls = 1949,                 /* -fsync-libcalls */
  OPT_fsyntax_only = 1950,                   /* -fsyntax-only */
  OPT_ftabstop_ = 1951,                      /* -ftabstop= */
  /* OPT_ftail_call_workaround = 1952, */    /* -ftail-call-workaround */
  OPT_ftail_call_workaround_ = 1953,         /* -ftail-call-workaround= */
  /* OPT_ftarget_help = 1954, */             /* -ftarget-help */
  OPT_ftemplate_backtrace_limit_ = 1955,     /* -ftemplate-backtrace-limit= */
  /* OPT_ftemplate_depth_ = 1956, */         /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 1957,               /* -ftemplate-depth= */
  OPT_ftest_coverage = 1958,                 /* -ftest-coverage */
  OPT_ftest_forall_temp = 1959,              /* -ftest-forall-temp */
  OPT_fthis_is_variable = 1960,              /* -fthis-is-variable */
  OPT_fthread_jumps = 1961,                  /* -fthread-jumps */
  OPT_fthreadsafe_statics = 1962,            /* -fthreadsafe-statics */
  OPT_ftime_report = 1963,                   /* -ftime-report */
  OPT_ftime_report_details = 1964,           /* -ftime-report-details */
  OPT_ftls_model_ = 1965,                    /* -ftls-model= */
  OPT_ftoplevel_reorder = 1966,              /* -ftoplevel-reorder */
  OPT_ftrace_debug = 1967,                   /* -ftrace-debug */
  OPT_ftracer = 1968,                        /* -ftracer */
  OPT_ftrack_macro_expansion = 1969,         /* -ftrack-macro-expansion */
  OPT_ftrack_macro_expansion_ = 1970,        /* -ftrack-macro-expansion= */
  OPT_ftrampoline_impl_ = 1971,              /* -ftrampoline-impl= */
  OPT_ftrampolines = 1972,                   /* -ftrampolines */
  OPT_ftransition_all = 1973,                /* -ftransition=all */
  OPT_ftransition_field = 1974,              /* -ftransition=field */
  OPT_ftransition_in = 1975,                 /* -ftransition=in */
  OPT_ftransition_nogc = 1976,               /* -ftransition=nogc */
  OPT_ftransition_templates = 1977,          /* -ftransition=templates */
  OPT_ftransition_tls = 1978,                /* -ftransition=tls */
  OPT_ftrapping_math = 1979,                 /* -ftrapping-math */
  OPT_ftrapv = 1980,                         /* -ftrapv */
  OPT_ftree_bit_ccp = 1981,                  /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 1982,         /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 1983,                      /* -ftree-ccp */
  OPT_ftree_ch = 1984,                       /* -ftree-ch */
  /* OPT_ftree_coalesce_inlined_vars = 1985, *//* -ftree-coalesce-inlined-vars */
  OPT_ftree_coalesce_vars = 1986,            /* -ftree-coalesce-vars */
  OPT_ftree_copy_prop = 1987,                /* -ftree-copy-prop */
  /* OPT_ftree_copyrename = 1988, */         /* -ftree-copyrename */
  OPT_ftree_cselim = 1989,                   /* -ftree-cselim */
  OPT_ftree_dce = 1990,                      /* -ftree-dce */
  OPT_ftree_dominator_opts = 1991,           /* -ftree-dominator-opts */
  OPT_ftree_dse = 1992,                      /* -ftree-dse */
  OPT_ftree_forwprop = 1993,                 /* -ftree-forwprop */
  OPT_ftree_fre = 1994,                      /* -ftree-fre */
  OPT_ftree_loop_distribute_patterns = 1995, /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 1996,        /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 1997,          /* -ftree-loop-if-convert */
  /* OPT_ftree_loop_if_convert_stores = 1998, *//* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 1999,                  /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 2000,             /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 2001, */        /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 2002,            /* -ftree-loop-optimize */
  OPT_ftree_loop_vectorize = 2003,           /* -ftree-loop-vectorize */
  /* OPT_ftree_lrs = 2004, */                /* -ftree-lrs */
  /* OPT_ftree_parallelize_loops = 2005, */  /* -ftree-parallelize-loops */
  OPT_ftree_parallelize_loops_ = 2006,       /* -ftree-parallelize-loops= */
  OPT_ftree_partial_pre = 2007,              /* -ftree-partial-pre */
  OPT_ftree_phiprop = 2008,                  /* -ftree-phiprop */
  OPT_ftree_pre = 2009,                      /* -ftree-pre */
  OPT_ftree_pta = 2010,                      /* -ftree-pta */
  OPT_ftree_reassoc = 2011,                  /* -ftree-reassoc */
  /* OPT_ftree_salias = 2012, */             /* -ftree-salias */
  OPT_ftree_scev_cprop = 2013,               /* -ftree-scev-cprop */
  OPT_ftree_sink = 2014,                     /* -ftree-sink */
  OPT_ftree_slp_vectorize = 2015,            /* -ftree-slp-vectorize */
  OPT_ftree_slsr = 2016,                     /* -ftree-slsr */
  OPT_ftree_sra = 2017,                      /* -ftree-sra */
  /* OPT_ftree_store_ccp = 2018, */          /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 2019, */    /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 2020,        /* -ftree-switch-conversion */
  OPT_ftree_tail_merge = 2021,               /* -ftree-tail-merge */
  OPT_ftree_ter = 2022,                      /* -ftree-ter */
  /* OPT_ftree_vect_loop_version = 2023, */  /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 2024,                /* -ftree-vectorize */
  /* OPT_ftree_vectorizer_verbose_ = 2025, *//* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 2026,                      /* -ftree-vrp */
  OPT_ftrivial_auto_var_init_ = 2027,        /* -ftrivial-auto-var-init= */
  OPT_funbounded_by_reference = 2028,        /* -funbounded-by-reference */
  OPT_funconstrained_commons = 2029,         /* -funconstrained-commons */
  OPT_funderscoring = 2030,                  /* -funderscoring */
  OPT_funit_at_a_time = 2031,                /* -funit-at-a-time */
  OPT_funittest = 2032,                      /* -funittest */
  OPT_funreachable_traps = 2033,             /* -funreachable-traps */
  OPT_funroll_all_loops = 2034,              /* -funroll-all-loops */
  OPT_funroll_completely_grow_size = 2035,   /* -funroll-completely-grow-size */
  OPT_funroll_loops = 2036,                  /* -funroll-loops */
  /* OPT_funsafe_loop_optimizations = 2037, *//* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 2038,     /* -funsafe-math-optimizations */
  OPT_funsigned = 2039,                      /* -funsigned */
  OPT_funsigned_bitfields = 2040,            /* -funsigned-bitfields */
  OPT_funsigned_char = 2041,                 /* -funsigned-char */
  OPT_funswitch_loops = 2042,                /* -funswitch-loops */
  OPT_funwind_tables = 2043,                 /* -funwind-tables */
  OPT_fuse_cxa_atexit = 2044,                /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 2045,     /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_ld_bfd = 2046,                    /* -fuse-ld=bfd */
  OPT_fuse_ld_gold = 2047,                   /* -fuse-ld=gold */
  OPT_fuse_ld_lld = 2048,                    /* -fuse-ld=lld */
  OPT_fuse_ld_mold = 2049,                   /* -fuse-ld=mold */
  OPT_fuse_ld_wild = 2050,                   /* -fuse-ld=wild */
  OPT_fuse_linker_plugin = 2051,             /* -fuse-linker-plugin */
  OPT_fuse_list_ = 2052,                     /* -fuse-list= */
  OPT_fvar_tracking = 2053,                  /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 2054,      /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 2055,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 2056,           /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 2057,/* -fvariable-expansion-in-unroller */
  /* OPT_fvect_cost_model = 2058, */         /* -fvect-cost-model */
  OPT_fvect_cost_model_ = 2059,              /* -fvect-cost-model= */
  OPT_fverbose_asm = 2060,                   /* -fverbose-asm */
  /* OPT_fversion = 2061, */                 /* -fversion */
  OPT_fversion_loops_for_strides = 2062,     /* -fversion-loops-for-strides */
  OPT_fversion_ = 2063,                      /* -fversion= */
  OPT_fvisibility_inlines_hidden = 2064,     /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 2065,          /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 2066,                   /* -fvisibility= */
  OPT_fvpt = 2067,                           /* -fvpt */
  OPT_fvtable_gc = 2068,                     /* -fvtable-gc */
  OPT_fvtable_thunks = 2069,                 /* -fvtable-thunks */
  OPT_fvtable_verify_ = 2070,                /* -fvtable-verify= */
  OPT_fvtv_counts = 2071,                    /* -fvtv-counts */
  OPT_fvtv_debug = 2072,                     /* -fvtv-debug */
  OPT_fweak = 2073,                          /* -fweak */
  OPT_fweak_templates = 2074,                /* -fweak-templates */
  OPT_fweb = 2075,                           /* -fweb */
  /* OPT_fwhole_file = 2076, */              /* -fwhole-file */
  OPT_fwhole_program = 2077,                 /* -fwhole-program */
  OPT_fwholediv = 2078,                      /* -fwholediv */
  OPT_fwholevalue = 2079,                    /* -fwholevalue */
  OPT_fwide_exec_charset_ = 2080,            /* -fwide-exec-charset= */
  OPT_fwideset = 2081,                       /* -fwideset */
  OPT_fworking_directory = 2082,             /* -fworking-directory */
  OPT_fwpa = 2083,                           /* -fwpa */
  OPT_fwpa_ = 2084,                          /* -fwpa= */
  OPT_fwrapv = 2085,                         /* -fwrapv */
  OPT_fwrapv_pointer = 2086,                 /* -fwrapv-pointer */
  OPT_fxref = 2087,                          /* -fxref */
  OPT_fyacc_debug = 2088,                    /* -fyacc-debug */
  /* OPT_fzee = 2089, */                     /* -fzee */
  OPT_fzero_call_used_regs_ = 2090,          /* -fzero-call-used-regs= */
  OPT_fzero_init_padding_bits_ = 2091,       /* -fzero-init-padding-bits= */
  OPT_fzero_initialized_in_bss = 2092,       /* -fzero-initialized-in-bss */
  OPT_fzero_link = 2093,                     /* -fzero-link */
  OPT_g = 2094,                              /* -g */
  OPT_gant = 2095,                           /* -gant */
  OPT_gas_loc_support = 2096,                /* -gas-loc-support */
  OPT_gas_locview_support = 2097,            /* -gas-locview-support */
  OPT_gbtf = 2098,                           /* -gbtf */
  OPT_gcodeview = 2099,                      /* -gcodeview */
  OPT_gcoff = 2100,                          /* -gcoff */
  OPT_gcoff1 = 2101,                         /* -gcoff1 */
  OPT_gcoff2 = 2102,                         /* -gcoff2 */
  OPT_gcoff3 = 2103,                         /* -gcoff3 */
  OPT_gcolumn_info = 2104,                   /* -gcolumn-info */
  OPT_gctf = 2105,                           /* -gctf */
  OPT_gdescribe_dies = 2106,                 /* -gdescribe-dies */
  OPT_gdwarf = 2107,                         /* -gdwarf */
  OPT_gdwarf_ = 2108,                        /* -gdwarf- */
  OPT_gdwarf32 = 2109,                       /* -gdwarf32 */
  OPT_gdwarf64 = 2110,                       /* -gdwarf64 */
  OPT_gen_decls = 2111,                      /* -gen-decls */
  OPT_ggdb = 2112,                           /* -ggdb */
  OPT_ggnu_pubnames = 2113,                  /* -ggnu-pubnames */
  OPT_gimple_stats = 2114,                   /* -gimple-stats */
  OPT_ginline_points = 2115,                 /* -ginline-points */
  OPT_ginternal_reset_location_views = 2116, /* -ginternal-reset-location-views */
  OPT_gnat = 2117,                           /* -gnat */
  OPT_gnatO = 2118,                          /* -gnatO */
  OPT_gno_ = 2119,                           /* -gno- */
  OPT_gno_pubnames = 2120,                   /* -gno-pubnames */
  OPT_gprune_btf = 2121,                     /* -gprune-btf */
  OPT_gpubnames = 2122,                      /* -gpubnames */
  OPT_grecord_gcc_switches = 2123,           /* -grecord-gcc-switches */
  OPT_gsplit_dwarf = 2124,                   /* -gsplit-dwarf */
  OPT_gstabs = 2125,                         /* -gstabs */
  OPT_gstabs_ = 2126,                        /* -gstabs+ */
  OPT_gstatement_frontiers = 2127,           /* -gstatement-frontiers */
  OPT_gstrict_dwarf = 2128,                  /* -gstrict-dwarf */
  OPT_gtoggle = 2129,                        /* -gtoggle */
  OPT_gvariable_location_views = 2130,       /* -gvariable-location-views */
  OPT_gvariable_location_views_incompat5 = 2131,/* -gvariable-location-views=incompat5 */
  OPT_gvms = 2132,                           /* -gvms */
  OPT_gxcoff = 2133,                         /* -gxcoff */
  OPT_gxcoff_ = 2134,                        /* -gxcoff+ */
  OPT_gz = 2135,                             /* -gz */
  OPT_gz_ = 2136,                            /* -gz= */
  OPT_h = 2137,                              /* -h */
  OPT_help = 2138,                           /* -help */
  OPT_idirafter = 2139,                      /* -idirafter */
  OPT_imacros = 2140,                        /* -imacros */
  OPT_imultiarch = 2141,                     /* -imultiarch */
  OPT_imultilib = 2142,                      /* -imultilib */
  OPT_include = 2143,                        /* -include */
  OPT_iplugindir_ = 2144,                    /* -iplugindir= */
  OPT_iprefix = 2145,                        /* -iprefix */
  OPT_iquote = 2146,                         /* -iquote */
  OPT_isysroot = 2147,                       /* -isysroot */
  OPT_isystem = 2148,                        /* -isystem */
  OPT_iwithprefix = 2149,                    /* -iwithprefix */
  OPT_iwithprefixbefore = 2150,              /* -iwithprefixbefore */
  OPT_k8 = 2151,                             /* -k8 */
  OPT_l = 2152,                              /* -l */
  OPT_lang_asm = 2153,                       /* -lang-asm */
  OPT_list = 2154,                           /* -list */
  OPT_m128bit_long_double = 2155,            /* -m128bit-long-double */
  OPT_m16 = 2156,                            /* -m16 */
  OPT_m32 = 2157,                            /* -m32 */
  OPT_m3dnow = 2158,                         /* -m3dnow */
  OPT_m3dnowa = 2159,                        /* -m3dnowa */
  OPT_m64 = 2160,                            /* -m64 */
  OPT_m80387 = 2161,                         /* -m80387 */
  OPT_m8bit_idiv = 2162,                     /* -m8bit-idiv */
  OPT_m96bit_long_double = 2163,             /* -m96bit-long-double */
  OPT_mabi_ = 2164,                          /* -mabi= */
  OPT_mabm = 2165,                           /* -mabm */
  OPT_maccumulate_outgoing_args = 2166,      /* -maccumulate-outgoing-args */
  OPT_maddress_mode_ = 2167,                 /* -maddress-mode= */
  OPT_madx = 2168,                           /* -madx */
  OPT_maes = 2169,                           /* -maes */
  OPT_main = 2170,                           /* -main */
  OPT_main_ = 2171,                          /* -main= */
  OPT_malign_data_ = 2172,                   /* -malign-data= */
  OPT_malign_double = 2173,                  /* -malign-double */
  OPT_malign_functions_ = 2174,              /* -malign-functions= */
  OPT_malign_jumps_ = 2175,                  /* -malign-jumps= */
  OPT_malign_loops_ = 2176,                  /* -malign-loops= */
  OPT_malign_stringops = 2177,               /* -malign-stringops */
  OPT_mamx_avx512 = 2178,                    /* -mamx-avx512 */
  OPT_mamx_bf16 = 2179,                      /* -mamx-bf16 */
  OPT_mamx_complex = 2180,                   /* -mamx-complex */
  OPT_mamx_fp16 = 2181,                      /* -mamx-fp16 */
  OPT_mamx_fp8 = 2182,                       /* -mamx-fp8 */
  OPT_mamx_int8 = 2183,                      /* -mamx-int8 */
  OPT_mamx_movrs = 2184,                     /* -mamx-movrs */
  OPT_mamx_tf32 = 2185,                      /* -mamx-tf32 */
  OPT_mamx_tile = 2186,                      /* -mamx-tile */
  OPT_mandroid = 2187,                       /* -mandroid */
  OPT_mapx_features_ = 2188,                 /* -mapx-features= */
  OPT_mapx_inline_asm_use_gpr32 = 2189,      /* -mapx-inline-asm-use-gpr32 */
  OPT_mapxf = 2190,                          /* -mapxf */
  OPT_march_ = 2191,                         /* -march= */
  OPT_masm_ = 2192,                          /* -masm= */
  OPT_mavx = 2193,                           /* -mavx */
  OPT_mavx10_1 = 2194,                       /* -mavx10.1 */
  OPT_mavx10_2 = 2195,                       /* -mavx10.2 */
  OPT_mavx2 = 2196,                          /* -mavx2 */
  OPT_mavx256_split_unaligned_load = 2197,   /* -mavx256-split-unaligned-load */
  OPT_mavx256_split_unaligned_store = 2198,  /* -mavx256-split-unaligned-store */
  OPT_mavx512bf16 = 2199,                    /* -mavx512bf16 */
  OPT_mavx512bitalg = 2200,                  /* -mavx512bitalg */
  OPT_mavx512bmm = 2201,                     /* -mavx512bmm */
  OPT_mavx512bw = 2202,                      /* -mavx512bw */
  OPT_mavx512cd = 2203,                      /* -mavx512cd */
  OPT_mavx512dq = 2204,                      /* -mavx512dq */
  OPT_mavx512f = 2205,                       /* -mavx512f */
  OPT_mavx512fp16 = 2206,                    /* -mavx512fp16 */
  OPT_mavx512ifma = 2207,                    /* -mavx512ifma */
  OPT_mavx512vbmi = 2208,                    /* -mavx512vbmi */
  OPT_mavx512vbmi2 = 2209,                   /* -mavx512vbmi2 */
  OPT_mavx512vl = 2210,                      /* -mavx512vl */
  OPT_mavx512vnni = 2211,                    /* -mavx512vnni */
  OPT_mavx512vp2intersect = 2212,            /* -mavx512vp2intersect */
  OPT_mavx512vpopcntdq = 2213,               /* -mavx512vpopcntdq */
  OPT_mavxifma = 2214,                       /* -mavxifma */
  OPT_mavxneconvert = 2215,                  /* -mavxneconvert */
  OPT_mavxvnni = 2216,                       /* -mavxvnni */
  OPT_mavxvnniint16 = 2217,                  /* -mavxvnniint16 */
  OPT_mavxvnniint8 = 2218,                   /* -mavxvnniint8 */
  OPT_mbionic = 2219,                        /* -mbionic */
  OPT_mbmi = 2220,                           /* -mbmi */
  OPT_mbmi2 = 2221,                          /* -mbmi2 */
  OPT_mbranch_cost_ = 2222,                  /* -mbranch-cost= */
  OPT_mcall_ms2sysv_xlogues = 2223,          /* -mcall-ms2sysv-xlogues */
  OPT_mcet_switch = 2224,                    /* -mcet-switch */
  OPT_mcld = 2225,                           /* -mcld */
  OPT_mcldemote = 2226,                      /* -mcldemote */
  OPT_mclflushopt = 2227,                    /* -mclflushopt */
  OPT_mclwb = 2228,                          /* -mclwb */
  OPT_mclzero = 2229,                        /* -mclzero */
  OPT_mcmodel_ = 2230,                       /* -mcmodel= */
  OPT_mcmpccxadd = 2231,                     /* -mcmpccxadd */
  /* OPT_mcpu_ = 2232, */                    /* -mcpu= */
  OPT_mcrc32 = 2233,                         /* -mcrc32 */
  OPT_mcx16 = 2234,                          /* -mcx16 */
  OPT_mdaz_ftz = 2235,                       /* -mdaz-ftz */
  OPT_mdirect_extern_access = 2236,          /* -mdirect-extern-access */
  OPT_mdispatch_scheduler = 2237,            /* -mdispatch-scheduler */
  OPT_mdump_tune_features = 2238,            /* -mdump-tune-features */
  OPT_menqcmd = 2239,                        /* -menqcmd */
  OPT_mf16c = 2240,                          /* -mf16c */
  OPT_mfancy_math_387 = 2241,                /* -mfancy-math-387 */
  OPT_mfentry = 2242,                        /* -mfentry */
  OPT_mfentry_name_ = 2243,                  /* -mfentry-name= */
  OPT_mfentry_section_ = 2244,               /* -mfentry-section= */
  OPT_mfma = 2245,                           /* -mfma */
  OPT_mfma4 = 2246,                          /* -mfma4 */
  OPT_mforce_drap = 2247,                    /* -mforce-drap */
  OPT_mforce_indirect_call = 2248,           /* -mforce-indirect-call */
  OPT_mfp_ret_in_387 = 2249,                 /* -mfp-ret-in-387 */
  OPT_mfpmath_ = 2250,                       /* -mfpmath= */
  OPT_mfsgsbase = 2251,                      /* -mfsgsbase */
  OPT_mfunction_return_ = 2252,              /* -mfunction-return= */
  /* OPT_mfused_madd = 2253, */              /* -mfused-madd */
  OPT_mfxsr = 2254,                          /* -mfxsr */
  OPT_mgather = 2255,                        /* -mgather */
  OPT_mgeneral_regs_only = 2256,             /* -mgeneral-regs-only */
  OPT_mgfni = 2257,                          /* -mgfni */
  OPT_mglibc = 2258,                         /* -mglibc */
  OPT_mhard_float = 2259,                    /* -mhard-float */
  OPT_mharden_sls_ = 2260,                   /* -mharden-sls= */
  OPT_mhle = 2261,                           /* -mhle */
  OPT_mhreset = 2262,                        /* -mhreset */
  OPT_miamcu = 2263,                         /* -miamcu */
  OPT_mieee_fp = 2264,                       /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 2265,      /* -mincoming-stack-boundary= */
  OPT_mindirect_branch_cs_prefix = 2266,     /* -mindirect-branch-cs-prefix */
  OPT_mindirect_branch_register = 2267,      /* -mindirect-branch-register */
  OPT_mindirect_branch_ = 2268,              /* -mindirect-branch= */
  OPT_minline_all_stringops = 2269,          /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 2270,  /* -minline-stringops-dynamically */
  OPT_minstrument_return_ = 2271,            /* -minstrument-return= */
  /* OPT_mintel_syntax = 2272, */            /* -mintel-syntax */
  OPT_mkl = 2273,                            /* -mkl */
  OPT_mlam_ = 2274,                          /* -mlam= */
  OPT_mlarge_data_threshold_ = 2275,         /* -mlarge-data-threshold= */
  OPT_mlong_double_128 = 2276,               /* -mlong-double-128 */
  OPT_mlong_double_64 = 2277,                /* -mlong-double-64 */
  OPT_mlong_double_80 = 2278,                /* -mlong-double-80 */
  OPT_mlwp = 2279,                           /* -mlwp */
  OPT_mlzcnt = 2280,                         /* -mlzcnt */
  OPT_mmanual_endbr = 2281,                  /* -mmanual-endbr */
  OPT_mmemcpy_strategy_ = 2282,              /* -mmemcpy-strategy= */
  OPT_mmemset_strategy_ = 2283,              /* -mmemset-strategy= */
  OPT_mmitigate_rop = 2284,                  /* -mmitigate-rop */
  OPT_mmmx = 2285,                           /* -mmmx */
  OPT_mmovbe = 2286,                         /* -mmovbe */
  OPT_mmovdir64b = 2287,                     /* -mmovdir64b */
  OPT_mmovdiri = 2288,                       /* -mmovdiri */
  OPT_mmove_max_ = 2289,                     /* -mmove-max= */
  OPT_mmovrs = 2290,                         /* -mmovrs */
  OPT_mmpx = 2291,                           /* -mmpx */
  OPT_mms_bitfields = 2292,                  /* -mms-bitfields */
  OPT_mmusl = 2293,                          /* -mmusl */
  OPT_mmwait = 2294,                         /* -mmwait */
  OPT_mmwaitx = 2295,                        /* -mmwaitx */
  OPT_mneeded = 2296,                        /* -mneeded */
  OPT_mno_align_stringops = 2297,            /* -mno-align-stringops */
  OPT_mno_default = 2298,                    /* -mno-default */
  OPT_mno_fancy_math_387 = 2299,             /* -mno-fancy-math-387 */
  OPT_mno_push_args = 2300,                  /* -mno-push-args */
  OPT_mno_red_zone = 2301,                   /* -mno-red-zone */
  OPT_mnop_mcount = 2302,                    /* -mnop-mcount */
  OPT_mnoreturn_no_callee_saved_registers = 2303,/* -mnoreturn-no-callee-saved-registers */
  OPT_momit_leaf_frame_pointer = 2304,       /* -momit-leaf-frame-pointer */
  OPT_mpartial_vector_fp_math = 2305,        /* -mpartial-vector-fp-math */
  OPT_mpc32 = 2306,                          /* -mpc32 */
  OPT_mpc64 = 2307,                          /* -mpc64 */
  OPT_mpc80 = 2308,                          /* -mpc80 */
  OPT_mpclmul = 2309,                        /* -mpclmul */
  OPT_mpcommit = 2310,                       /* -mpcommit */
  OPT_mpconfig = 2311,                       /* -mpconfig */
  OPT_mpku = 2312,                           /* -mpku */
  OPT_mpopcnt = 2313,                        /* -mpopcnt */
  /* OPT_mprefer_avx128 = 2314, */           /* -mprefer-avx128 */
  OPT_mprefer_vector_width_ = 2315,          /* -mprefer-vector-width= */
  OPT_mpreferred_stack_boundary_ = 2316,     /* -mpreferred-stack-boundary= */
  OPT_mprefetchi = 2317,                     /* -mprefetchi */
  OPT_mprfchw = 2318,                        /* -mprfchw */
  OPT_mptwrite = 2319,                       /* -mptwrite */
  OPT_mpush_args = 2320,                     /* -mpush-args */
  OPT_mraoint = 2321,                        /* -mraoint */
  OPT_mrdpid = 2322,                         /* -mrdpid */
  OPT_mrdrnd = 2323,                         /* -mrdrnd */
  OPT_mrdseed = 2324,                        /* -mrdseed */
  OPT_mrecip = 2325,                         /* -mrecip */
  OPT_mrecip_ = 2326,                        /* -mrecip= */
  OPT_mrecord_mcount = 2327,                 /* -mrecord-mcount */
  OPT_mrecord_return = 2328,                 /* -mrecord-return */
  OPT_mred_zone = 2329,                      /* -mred-zone */
  OPT_mregparm_ = 2330,                      /* -mregparm= */
  OPT_mrelax_cmpxchg_loop = 2331,            /* -mrelax-cmpxchg-loop */
  OPT_mrtd = 2332,                           /* -mrtd */
  OPT_mrtm = 2333,                           /* -mrtm */
  OPT_msahf = 2334,                          /* -msahf */
  OPT_mscatter = 2335,                       /* -mscatter */
  OPT_mserialize = 2336,                     /* -mserialize */
  OPT_msgx = 2337,                           /* -msgx */
  OPT_msha = 2338,                           /* -msha */
  OPT_msha512 = 2339,                        /* -msha512 */
  OPT_mshstk = 2340,                         /* -mshstk */
  OPT_mskip_rax_setup = 2341,                /* -mskip-rax-setup */
  OPT_msm3 = 2342,                           /* -msm3 */
  OPT_msm4 = 2343,                           /* -msm4 */
  OPT_msoft_float = 2344,                    /* -msoft-float */
  OPT_msse = 2345,                           /* -msse */
  OPT_msse2 = 2346,                          /* -msse2 */
  OPT_msse2avx = 2347,                       /* -msse2avx */
  OPT_msse3 = 2348,                          /* -msse3 */
  OPT_msse4 = 2349,                          /* -msse4 */
  OPT_msse4_1 = 2350,                        /* -msse4.1 */
  OPT_msse4_2 = 2351,                        /* -msse4.2 */
  OPT_msse4a = 2352,                         /* -msse4a */
  /* OPT_msse5 = 2353, */                    /* -msse5 */
  OPT_msseregparm = 2354,                    /* -msseregparm */
  OPT_mssse3 = 2355,                         /* -mssse3 */
  OPT_mstack_arg_probe = 2356,               /* -mstack-arg-probe */
  OPT_mstack_protector_guard_offset_ = 2357, /* -mstack-protector-guard-offset= */
  OPT_mstack_protector_guard_reg_ = 2358,    /* -mstack-protector-guard-reg= */
  OPT_mstack_protector_guard_symbol_ = 2359, /* -mstack-protector-guard-symbol= */
  OPT_mstack_protector_guard_ = 2360,        /* -mstack-protector-guard= */
  OPT_mstackrealign = 2361,                  /* -mstackrealign */
  OPT_mstore_max_ = 2362,                    /* -mstore-max= */
  OPT_mstringop_strategy_ = 2363,            /* -mstringop-strategy= */
  OPT_mstv = 2364,                           /* -mstv */
  OPT_mtbm = 2365,                           /* -mtbm */
  OPT_mtls_dialect_ = 2366,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 2367,           /* -mtls-direct-seg-refs */
  OPT_mtsxldtrk = 2368,                      /* -mtsxldtrk */
  OPT_mtune_ctrl_ = 2369,                    /* -mtune-ctrl= */
  OPT_mtune_ = 2370,                         /* -mtune= */
  OPT_muclibc = 2371,                        /* -muclibc */
  OPT_muintr = 2372,                         /* -muintr */
  OPT_munroll_only_small_loops = 2373,       /* -munroll-only-small-loops */
  OPT_musermsr = 2374,                       /* -musermsr */
  OPT_mvaes = 2375,                          /* -mvaes */
  OPT_mveclibabi_ = 2376,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 2377,              /* -mvect8-ret-in-mem */
  OPT_mvpclmulqdq = 2378,                    /* -mvpclmulqdq */
  OPT_mvzeroupper = 2379,                    /* -mvzeroupper */
  OPT_mwaitpkg = 2380,                       /* -mwaitpkg */
  OPT_mwbnoinvd = 2381,                      /* -mwbnoinvd */
  OPT_mwidekl = 2382,                        /* -mwidekl */
  OPT_mx32 = 2383,                           /* -mx32 */
  OPT_mxop = 2384,                           /* -mxop */
  OPT_mxsave = 2385,                         /* -mxsave */
  OPT_mxsavec = 2386,                        /* -mxsavec */
  OPT_mxsaveopt = 2387,                      /* -mxsaveopt */
  OPT_mxsaves = 2388,                        /* -mxsaves */
  OPT_n = 2389,                              /* -n */
  OPT_name_sort = 2390,                      /* -name-sort */
  OPT_no_canonical_prefixes = 2391,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 2392,              /* -no-integrated-cpp */
  OPT_no_pie = 2393,                         /* -no-pie */
  OPT_nocpp = 2394,                          /* -nocpp */
  OPT_nodefaultlibs = 2395,                  /* -nodefaultlibs */
  OPT_nolibc = 2396,                         /* -nolibc */
  OPT_nomain = 2397,                         /* -nomain */
  OPT_nophoboslib = 2398,                    /* -nophoboslib */
  OPT_nostartfiles = 2399,                   /* -nostartfiles */
  OPT_nostdinc = 2400,                       /* -nostdinc */
  OPT_nostdinc__ = 2401,                     /* -nostdinc++ */
  OPT_nostdlib = 2402,                       /* -nostdlib */
  OPT_nostdlib__ = 2403,                     /* -nostdlib++ */
  OPT_o = 2404,                              /* -o */
  OPT_objects = 2405,                        /* -objects */
  OPT_p = 2406,                              /* -p */
  OPT_pass_exit_codes = 2407,                /* -pass-exit-codes */
  /* OPT_pedantic = 2408, */                 /* -pedantic */
  OPT_pedantic_errors = 2409,                /* -pedantic-errors */
  OPT_pg = 2410,                             /* -pg */
  OPT_pie = 2411,                            /* -pie */
  OPT_pipe = 2412,                           /* -pipe */
  OPT_posix = 2413,                          /* -posix */
  OPT_preprocess = 2414,                     /* -preprocess */
  OPT_print_autofdo_gcov_version = 2415,     /* -print-autofdo-gcov-version */
  OPT_print_file_name_ = 2416,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 2417,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 2418,          /* -print-multi-directory */
  OPT_print_multi_lib = 2419,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 2420,       /* -print-multi-os-directory */
  OPT_print_multiarch = 2421,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 2422,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 2423,               /* -print-prog-name= */
  OPT_print_search_dirs = 2424,              /* -print-search-dirs */
  OPT_print_sysroot = 2425,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 2426,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 2427,                    /* -print-value */
  OPT_profile = 2428,                        /* -profile */
  OPT_pthread = 2429,                        /* -pthread */
  OPT_quiet = 2430,                          /* -quiet */
  OPT_r = 2431,                              /* -r */
  OPT_rdynamic = 2432,                       /* -rdynamic */
  OPT_remap = 2433,                          /* -remap */
  OPT_reverse_sort = 2434,                   /* -reverse-sort */
  OPT_s = 2435,                              /* -s */
  OPT_save_temps = 2436,                     /* -save-temps */
  OPT_save_temps_ = 2437,                    /* -save-temps= */
  OPT_shared = 2438,                         /* -shared */
  OPT_shared_libga68 = 2439,                 /* -shared-libga68 */
  OPT_shared_libgcc = 2440,                  /* -shared-libgcc */
  OPT_shared_libphobos = 2441,               /* -shared-libphobos */
  OPT_size_sort = 2442,                      /* -size-sort */
  /* OPT_specs = 2443, */                    /* -specs */
  OPT_specs_ = 2444,                         /* -specs= */
  OPT_static = 2445,                         /* -static */
  OPT_static_libasan = 2446,                 /* -static-libasan */
  OPT_static_libga68 = 2447,                 /* -static-libga68 */
  OPT_static_libgcc = 2448,                  /* -static-libgcc */
  OPT_static_libgcobol = 2449,               /* -static-libgcobol */
  OPT_static_libgfortran = 2450,             /* -static-libgfortran */
  OPT_static_libgm2 = 2451,                  /* -static-libgm2 */
  OPT_static_libgo = 2452,                   /* -static-libgo */
  OPT_static_libhwasan = 2453,               /* -static-libhwasan */
  OPT_static_liblsan = 2454,                 /* -static-liblsan */
  OPT_static_libmpx = 2455,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 2456,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 2457,               /* -static-libphobos */
  OPT_static_libquadmath = 2458,             /* -static-libquadmath */
  OPT_static_libstdc__ = 2459,               /* -static-libstdc++ */
  OPT_static_libtsan = 2460,                 /* -static-libtsan */
  OPT_static_libubsan = 2461,                /* -static-libubsan */
  OPT_static_pie = 2462,                     /* -static-pie */
  OPT_std_algol68 = 2463,                    /* -std=algol68 */
  /* OPT_std_c__03 = 2464, */                /* -std=c++03 */
  /* OPT_std_c__0x = 2465, */                /* -std=c++0x */
  OPT_std_c__11 = 2466,                      /* -std=c++11 */
  OPT_std_c__14 = 2467,                      /* -std=c++14 */
  OPT_std_c__17 = 2468,                      /* -std=c++17 */
  /* OPT_std_c__1y = 2469, */                /* -std=c++1y */
  /* OPT_std_c__1z = 2470, */                /* -std=c++1z */
  OPT_std_c__20 = 2471,                      /* -std=c++20 */
  OPT_std_c__23 = 2472,                      /* -std=c++23 */
  OPT_std_c__26 = 2473,                      /* -std=c++26 */
  /* OPT_std_c__2a = 2474, */                /* -std=c++2a */
  /* OPT_std_c__2b = 2475, */                /* -std=c++2b */
  /* OPT_std_c__2c = 2476, */                /* -std=c++2c */
  OPT_std_c__98 = 2477,                      /* -std=c++98 */
  OPT_std_c11 = 2478,                        /* -std=c11 */
  OPT_std_c17 = 2479,                        /* -std=c17 */
  /* OPT_std_c18 = 2480, */                  /* -std=c18 */
  /* OPT_std_c1x = 2481, */                  /* -std=c1x */
  OPT_std_c23 = 2482,                        /* -std=c23 */
  /* OPT_std_c2x = 2483, */                  /* -std=c2x */
  OPT_std_c2y = 2484,                        /* -std=c2y */
  /* OPT_std_c89 = 2485, */                  /* -std=c89 */
  OPT_std_c90 = 2486,                        /* -std=c90 */
  OPT_std_c99 = 2487,                        /* -std=c99 */
  /* OPT_std_c9x = 2488, */                  /* -std=c9x */
  OPT_std_d2024 = 2489,                      /* -std=d2024 */
  OPT_std_d202y = 2490,                      /* -std=d202y */
  OPT_std_f2003 = 2491,                      /* -std=f2003 */
  OPT_std_f2008 = 2492,                      /* -std=f2008 */
  OPT_std_f2008ts = 2493,                    /* -std=f2008ts */
  OPT_std_f2018 = 2494,                      /* -std=f2018 */
  OPT_std_f2023 = 2495,                      /* -std=f2023 */
  OPT_std_f202y = 2496,                      /* -std=f202y */
  OPT_std_f95 = 2497,                        /* -std=f95 */
  OPT_std_gnu = 2498,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 2499, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 2500, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 2501,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 2502,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 2503,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 2504, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 2505, */              /* -std=gnu++1z */
  OPT_std_gnu__20 = 2506,                    /* -std=gnu++20 */
  OPT_std_gnu__23 = 2507,                    /* -std=gnu++23 */
  OPT_std_gnu__26 = 2508,                    /* -std=gnu++26 */
  /* OPT_std_gnu__2a = 2509, */              /* -std=gnu++2a */
  /* OPT_std_gnu__2b = 2510, */              /* -std=gnu++2b */
  /* OPT_std_gnu__2c = 2511, */              /* -std=gnu++2c */
  OPT_std_gnu__98 = 2512,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 2513,                      /* -std=gnu11 */
  OPT_std_gnu17 = 2514,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 2515, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 2516, */                /* -std=gnu1x */
  OPT_std_gnu23 = 2517,                      /* -std=gnu23 */
  /* OPT_std_gnu2x = 2518, */                /* -std=gnu2x */
  OPT_std_gnu2y = 2519,                      /* -std=gnu2y */
  OPT_std_gnu68 = 2520,                      /* -std=gnu68 */
  /* OPT_std_gnu89 = 2521, */                /* -std=gnu89 */
  OPT_std_gnu90 = 2522,                      /* -std=gnu90 */
  OPT_std_gnu99 = 2523,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 2524, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 2525, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 2526,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 2527, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 2528, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 2529, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 2530, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 2531, */         /* -std=iso9899:2018 */
  /* OPT_std_iso9899_2024 = 2532, */         /* -std=iso9899:2024 */
  OPT_std_legacy = 2533,                     /* -std=legacy */
  OPT_stdlib_ = 2534,                        /* -stdlib= */
  OPT_symbol_ = 2535,                        /* -symbol= */
  OPT_symbolic = 2536,                       /* -symbolic */
  OPT_t = 2537,                              /* -t */
  OPT_time = 2538,                           /* -time */
  OPT_time_ = 2539,                          /* -time= */
  OPT_tno_android_cc = 2540,                 /* -tno-android-cc */
  OPT_tno_android_ld = 2541,                 /* -tno-android-ld */
  OPT_traditional = 2542,                    /* -traditional */
  OPT_traditional_cpp = 2543,                /* -traditional-cpp */
  OPT_tree_stats = 2544,                     /* -tree-stats */
  OPT_trigraphs = 2545,                      /* -trigraphs */
  OPT_truncate = 2546,                       /* -truncate */
  OPT_type_stats = 2547,                     /* -type-stats */
  OPT_u = 2548,                              /* -u */
  OPT_undef = 2549,                          /* -undef */
  OPT_v = 2550,                              /* -v */
  OPT_version = 2551,                        /* -version */
  OPT_w = 2552,                              /* -w */
  OPT_wrapper = 2553,                        /* -wrapper */
  OPT_x = 2554,                              /* -x */
  OPT_z = 2555,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
