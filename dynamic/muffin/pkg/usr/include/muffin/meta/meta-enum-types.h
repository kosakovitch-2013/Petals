...
/* enumerations from "common.h" */
META_EXPORT GType meta_frame_flags_get_type (void) G_GNUC_CONST;
#define META_TYPE_FRAME_FLAGS (meta_frame_flags_get_type())
...
META_EXPORT GType meta_virtual_modifier_get_type (void) G_GNUC_CONST;
#define META_TYPE_VIRTUAL_MODIFIER (meta_virtual_modifier_get_type())
...
META_EXPORT GType meta_x11_background_transition_get_type (void) G_GNUC_CONST;
#define META_TYPE_X11_BACKGROUND_TRANSITION (meta_x11_background_transition_get_type())
...
META_EXPORT GType meta_pad_action_type_get_type (void) G_GNUC_CONST;
#define META_TYPE_PAD_ACTION_TYPE (meta_pad_action_type_get_type())
META_EXPORT GType meta_tile_mode_get_type (void) G_GNUC_CONST;
#define META_TYPE_TILE_MODE (meta_tile_mode_get_type())
...
META_EXPORT GType meta_list_windows_flags_get_type (void) G_GNUC_CONST;
#define META_TYPE_LIST_WINDOWS_FLAGS (meta_list_windows_flags_get_type())
...
META_EXPORT GType meta_xrandr_rotation_get_type (void) G_GNUC_CONST;
#define META_TYPE_XRANDR_ROTATION (meta_xrandr_rotation_get_type())
/* enumerations from "meta-plugin.h" */
META_EXPORT GType meta_modal_options_get_type (void) G_GNUC_CONST;
#define META_TYPE_MODAL_OPTIONS (meta_modal_options_get_type())
...
/* enumerations from "meta-window-actor.h" */
META_EXPORT GType meta_shadow_mode_get_type (void) G_GNUC_CONST;
#define META_TYPE_SHADOW_MODE (meta_shadow_mode_get_type())
...
META_EXPORT GType meta_locale_direction_get_type (void) G_GNUC_CONST;
#define META_TYPE_LOCALE_DIRECTION (meta_locale_direction_get_type())
